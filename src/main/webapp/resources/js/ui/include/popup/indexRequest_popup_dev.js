...
$(document).ready(function() {
	...
	$("#indexsRequestList").datagrid({
		...
		columns:[[
			...
			{field:'table_name',title:'테이블명',width:"30%",halign:"center",align:'center',sortable:"true"},
			{field:'index_name',title:'인덱스명',editor:'textbox',width:"30%",halign:"center",align:'center',sortable:"true"},
			{field:'index_column_name',title:'인덱스컬럼',editor:'textbox',width:"30%",halign:"center",align:'left',sortable:"true"},
			{field:'before_index_column_name',title:'변경전 인덱스컬럼',hidden:"true"}
		]],
...
//	console.log("Btn_Search");
	...
	ajaxCall("/IndexDesignMaintenance/IndexList",
			$("#indexRequest_form"),
			"POST",
			callback_Indexs);		
}
...
//선택반영
function Btn_IndexSelectAndApply(){
