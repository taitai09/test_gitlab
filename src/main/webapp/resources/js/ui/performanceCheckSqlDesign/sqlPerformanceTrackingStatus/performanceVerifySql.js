...
$(document).ready(function() {
	...
	$('#end_dt').datebox('setValue', today.toLocaleDateString() );
...
function isValidationCheck() {
	if( $('#wrkjob_cd_top_level').combotree('getValue') == '' ) {
...
//	ajaxCall("/PerformanceCheckSql/loadPerformanceCheckSql",
	ajaxCall("/RunSqlPerformanceChangeTracking/loadPerformanceVerifySql",
			$("#submit_form"),
			"POST",
...
function Excel_Download(){
	...
	$("#submit_form").attr("action","/RunSqlPerformanceChangeTracking/loadPerformanceVerifySqlExcelDown");
	$("#submit_form").submit();
