		...
		onSelect: function(title,index){
			...
			case 0:
				...
				if(sqlPerformanceTraceStatusDesignIF1Src == undefined || sqlPerformanceTraceStatusDesignIF1Src == ""){
					document.getElementById('sqlPerformanceTraceStatusDesignIF1').src="/RunSqlPerformanceChangeTracking/PerformanceVerifySql";
				}
			...
			case 1:
				...
				if(sqlPerformanceTraceStatusDesignIF2Src == undefined || sqlPerformanceTraceStatusDesignIF2Src == ""){
					document.getElementById('sqlPerformanceTraceStatusDesignIF2').src="/RunSqlPerformanceChangeTracking/ExceptionHandlingRunSql";
				}
			...
			case 2:
				...
				if(sqlPerformanceTraceStatusDesignIF3Src == undefined || sqlPerformanceTraceStatusDesignIF3Src == ""){
					document.getElementById('sqlPerformanceTraceStatusDesignIF3').src="/RunSqlPerformanceChangeTracking/SqlPerformanceTrackingStatusChart";
				}
