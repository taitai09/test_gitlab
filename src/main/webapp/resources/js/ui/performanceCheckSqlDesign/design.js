		...
		onSelect: function(title,index){
			...
			case 0:
				...
				if(performanceCheckSqlDesignIF1Src == undefined || performanceCheckSqlDesignIF1Src == ""){
					document.getElementById('performanceCheckSqlDesignIF1').src="/PerformanceCheckSqlDesign/sqlPerformanceTraceStatusDesign";
				}
			...
			case 1:
				...
				if(performanceCheckSqlDesignIF22Src == undefined || performanceCheckSqlDesignIF22Src == ""){
					document.getElementById('performanceCheckSqlDesignIF2').src="/PerformanceCheckSqlDesign/sqls?menu_id=" + $('#menu_id').val();
...
function selectTab1(param){
	...
	document.getElementById('performanceCheckSqlDesignIF2').src="/PerformanceCheckSqlDesign/sqls?" + param + "&menu_id=" + $('#menu_id').val();
