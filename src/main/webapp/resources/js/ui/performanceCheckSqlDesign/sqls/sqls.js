	...
	$('#checkPass').checkbox({
		onChange:function(val) {
			if(val) {
				...
				if($('#checkFail').checkbox('options').checked == true) {
					$('#after_fail_yn_condition').val('N');		// 부적합
				} else {
					$('#after_fail_yn_condition').val('');		// 전체
				}
			}
...
function loadExceptionHandlingMethodCombobox() {
	$('#selectSqlPerfTrace').combobox({
		url:"/ExceptionHandlingSql/exceptionHandlingMethod?isAll=Y",
		method:"get",
		valueField:'cd',
		textField:'cd_nm',
...
function createTableList() {
	$("#tableList").treegrid({
		...
		columns:[[
			...
			{field:'dbio',title:'SQL 식별자</br>(DBIO)',halign:"center",align:'left',width:"200px",rowspan:2},
			...
			{field:'after_executions',title:'수행횟수',halign:"center",align:'right',width:"90px",rowspan:2},
			{field:'exception_prc_meth_nm',title:'에외</br>방법',halign:"center",align:'center',width:"50px",rowspan:2},
			{field:'after_fail_yn',title:'부적합</br>여부',halign:"center",align:'center',width:"50px",rowspan:2,styler:reverseStyler},
			{field:'before_fail_yn',title:'이전</br>부적합</br>여부',halign:"center",align:'center',width:"50px",rowspan:2,styler:reverseStyler},
			{field:'program_exec_dt',title:'성능점검일자',halign:"center",align:'center',width:"80px",rowspan:2},
			...
			{field:'test_elapsed_time',title:'배포',halign:"center",align:'right',width:"80px"},
			{field:'after_prd_elapsed_time',title:'운영',halign:"center",align:'right',width:"80px",formatter:formatElapsedTime},
			{field:'elapsed_time_activity',title:'Activity(%)',halign:"center",align:'right',width:"70px",styler:gradientStyler},
			{field:'test_buffer_gets',title:'배포',halign:"center",align:'right',width:"80px"},
			{field:'after_prd_buffer_gets',title:'운영',halign:"center",align:'right',width:"80px",formatter:formatBufferGets},
			{field:'buffer_gets_activity',title:'Activity(%)',halign:"center",align:'right',width:"70px",styler:gradientStyler},
			{field:'test_rows_processed',title:'배포',halign:"center",align:'right',width:"80px"},
			{field:'after_prd_rows_processed',title:'운영',halign:"center",align:'right',width:"80px"},
...
function testTableList() {
	...
	try {
		json_string_callback_common(JSON.stringify(testData), '#tableList', true);
	} catch(err) {
		console.error(err.message);
	}
...
var testData = {
		totalCount:3,
		rows: [{"dbio":"/gs/ORDERS_70000_01/ORDERLIST3","program_nm":"Test 차트","program_id":"58608","after_prd_sql_id":"dmf6sfpt7r99s"
				,"after_prd_plan_hash_value":"3691432305","prd_plan_change_yn":"Y","after_executions":null,"except_yn":"N"
				,"after_fail_yn":"N","before_fail_yn":"N","test_elapsed_time":0.02,"after_prd_elapsed_time":0.13,"elapsed_time_activity":70.01
				,"test_buffer_gets":1.2,"after_prd_buffer_gets":0.8,"buffer_gets_activity":30,"test_sql_id":"dmf6sfpt7r99s"
				,"before_prd_sql_id":"c038cmf3d94rq","before_prd_plan_hash_value":"1942058004","dbid":"212205444"
				,"perf_check_step_id":"1","program_execute_tms":"2","perf_check_id":"13403"
			},{
				"dbio":"/gs/ORDERS_70000_01/ORDERLIST3","program_nm":"Test 이전 운영 성능","program_id":"58608","after_prd_sql_id":"dmf6sfpt7r99s"
				,"after_prd_plan_hash_value":"3691432305","prd_plan_change_yn":"Y","after_executions":null,"except_yn":"N"
				,"after_fail_yn":"N","before_fail_yn":"N","test_elapsed_time":0.02,"after_prd_elapsed_time":0.13,"elapsed_time_activity":70.01
				,"test_buffer_gets":1.2,"after_prd_buffer_gets":0.8,"buffer_gets_activity":30,"test_sql_id":"dmf6sfpt7r99s"
				,"before_prd_sql_id":"0kyc8wpw0hnht","before_prd_plan_hash_value":"2830711815","dbid":"212205444"
				,"perf_check_step_id":"1","program_execute_tms":"2","perf_check_id":"13403"
			},{
				"dbio":"/gs/ORDERS_70000_01/ORDERLIST3","program_nm":"Test 성능점검","program_id":"59738","after_prd_sql_id":"dmf6sfpt7r99s"
				,"after_prd_plan_hash_value":"3691432305","prd_plan_change_yn":"Y","after_executions":null,"except_yn":"Y"
				,"after_fail_yn":"Y","before_fail_yn":"Y","test_elapsed_time":2.02,"after_prd_elapsed_time":0.13,"elapsed_time_activity":20.01
				,"test_buffer_gets":1.2,"after_prd_buffer_gets":9.8,"buffer_gets_activity":90,"test_sql_id":"cacty3m95yy4g"
				,"before_prd_sql_id":"dmf6sfpt7r99s","before_prd_plan_hash_value":"3691432305","dbid":"191205457"
				,"perf_check_step_id":"1","program_execute_tms":"1","perf_check_id":"13403"
			},{
				"dbio":"/gs/ORDERS_70000_01/ORDERLIST3","program_nm":"Test 배포후 운영성능","program_id":"59738","after_prd_sql_id":"3r3anusv0vyvg"
				,"after_prd_plan_hash_value":"463930839","prd_plan_change_yn":"Y","after_executions":null,"except_yn":"Y"
				,"after_fail_yn":"Y","before_fail_yn":"Y","test_elapsed_time":2.02,"after_prd_elapsed_time":0.13,"elapsed_time_activity":20.01
				,"test_buffer_gets":1.2,"after_prd_buffer_gets":9.8,"buffer_gets_activity":90,"test_sql_id":"cacty3m95yy4g"
				,"before_prd_sql_id":"dmf6sfpt7r99s","before_prd_plan_hash_value":"3691432305","dbid":"212205444"
				,"perf_check_step_id":"1","program_execute_tms":"1","perf_check_id":"13403"
				,"prd_buffer_gets_increase_ratio":"2.7","prd_elap_time_increase_ratio":"57.9","prd_rows_proc_increase_ratio":"98.1"
			},{
				"dbio":"/gs/ORDERS_70000_01/ORDERLIST3","program_nm":"Test 성능 점검 및 배포후 운영성능","program_id":"59738","after_prd_sql_id":"3r3anusv0vyvg"
				,"after_prd_plan_hash_value":"463930839","prd_plan_change_yn":"Y","after_executions":null,"except_yn":"Y"
				,"after_fail_yn":"Y","before_fail_yn":"Y","test_elapsed_time":2.02,"after_prd_elapsed_time":0.13,"elapsed_time_activity":20.01
				,"test_buffer_gets":1.2,"after_prd_buffer_gets":9.8,"buffer_gets_activity":90,"test_sql_id":"cacty3m95yy4g"
				,"before_prd_sql_id":"dmf6sfpt7r99s","before_prd_plan_hash_value":"3691432305","dbid":"212205444"
				...
				"dbio":"/gs/ORDERS_70000_01/ORDERLIST3","program_nm":"Test SQL Info","program_id":"58608","after_prd_sql_id":"dmf6sfpt7r99s"
				,"after_prd_plan_hash_value":"3691432305","prd_plan_change_yn":"Y","after_executions":null,"except_yn":"N"
				,"after_fail_yn":"N","before_fail_yn":"N","test_elapsed_time":0.02,"after_prd_elapsed_time":0.13,"elapsed_time_activity":70.01
				,"test_buffer_gets":1.2,"after_prd_buffer_gets":0.8,"buffer_gets_activity":30,"test_sql_id":"dmf6sfpt7r99s"
				,"before_prd_sql_id":"dmf6sfpt7r99s","before_prd_plan_hash_value":"3691432305","dbid":"191205457"
				...
				"dbio":"/gs/ORDERS_70000_01/ORDERLIST3","program_nm":"Test SQL Info","program_id":"59738","after_prd_sql_id":"dmf6sfpt7r99s"
				,"after_prd_plan_hash_value":"3691432305","prd_plan_change_yn":"Y","after_executions":null,"except_yn":"Y"
				,"after_fail_yn":"Y","before_fail_yn":"Y","test_elapsed_time":2.02,"after_prd_elapsed_time":0.13,"elapsed_time_activity":20.01
				,"test_buffer_gets":1.2,"after_prd_buffer_gets":9.8,"buffer_gets_activity":90,"test_sql_id":"dmf6sfpt7r99s"
				,"before_prd_sql_id":"dmf6sfpt7r99s","before_prd_plan_hash_value":"3691432305","dbid":"191205457"
				,"perf_check_step_id":"1","program_execute_tms":"1","perf_check_id":"13403"
			},{
				"dbio":"/gs/ORDERS_70000_01/ORDERLIST3","program_nm":"Test 성능 점검 결과 부적합","program_id":"58611","after_prd_sql_id":"dmf6sfpt7r99s"
				,"after_prd_plan_hash_value":"3691432305","prd_plan_change_yn":"Y","after_executions":null,"except_yn":"Y"
				,"after_fail_yn":"Y","before_fail_yn":"Y","test_elapsed_time":2.02,"after_prd_elapsed_time":0.13,"elapsed_time_activity":20.01
				,"test_buffer_gets":1.2,"after_prd_buffer_gets":9.8,"buffer_gets_activity":90,"test_sql_id":"dmf6sfpt7r99s"
				,"before_prd_sql_id":"dmf6sfpt7r99s","before_prd_plan_hash_value":"3691432305","dbid":"191205457"
				...
				"dbio":"/gs/ORDERS_70000_01/ORDERLIST3","program_nm":"Test 프로그램 정보","program_id":"61001","after_prd_sql_id":"dmf6sfpt7r99s"
				,"after_prd_plan_hash_value":"3691432305","prd_plan_change_yn":"Y","after_executions":null,"except_yn":"Y"
				,"after_fail_yn":"Y","before_fail_yn":"Y","test_elapsed_time":2.02,"after_prd_elapsed_time":0.13,"elapsed_time_activity":20.01
				,"test_buffer_gets":1.2,"after_prd_buffer_gets":9.8,"buffer_gets_activity":90,"test_sql_id":"dmf6sfpt7r99s"
				,"before_prd_sql_id":"dmf6sfpt7r99s","before_prd_plan_hash_value":"3691432305","dbid":"191205457"
				,"perf_check_step_id":"1","program_execute_tms":"1","perf_check_id":"18201"
			}]
};
...
function showTuningReqPopup(){
	...
	$('#assign_form #dbid_array').val(strRight(dbidArray, 1));
	$('#assign_form #after_prd_sql_id_array').val(strRight(sqlIdArray,1));
	$('#assign_form #after_prd_plan_hash_value_array').val(strRight(planHashValueArray, 1));
	$('#assign_form #perf_check_step_id_array').val(strRight(perfCheckStepIdArray, 1));
	$('#assign_form #wrkjob_cd_array').val(strRight(wrkjobCdArray, 1));
	$('#assign_form #executions_array').val(strRight(executionsArray, 1));
	$('#assign_form #avg_buffer_gets_array').val(strRight(avgBufferGetsArray, 1));
	$('#assign_form #avg_elapsed_time_array').val(strRight(avgElapsedTimeArray, 1));
	$('#assign_form #avg_row_processed_array').val(strRight(avgRowProcessedArray, 1));
	$('#assign_form #perf_check_id_array').val(strRight(perfCheckIdArray, 1));
	$('#assign_form #program_id_array').val(strRight(programIdArray, 1));
	$('#assign_form #dbio_array').val(strRight(dbioArray, 1));
...
function Excel_Download(){
	...
	$("#submit_form").attr("action","/Sqls/excelDown");
	$("#submit_form").submit();
...
function loadSqlPerformanceTrace(row) {
	...
	if($('#bottomSqlsTab').tabs('getTabIndex', tab) == 0) {
		document.getElementById('bottomSqlsTabDesignIF1').src="/Sqls/sqlPerformanceTrace?menu_id=" + $('#menu_id').val();
	} else {
		loadTabs(0);
	}
}
...
function loadTabs(index) {
	...
	case 0:
		...
		break;
	case 1:
		document.getElementById('bottomSqlsTabDesignIF2').src="/Sqls/sqlInfo";
		$('#btn_sqlInfo_pop').css('visibility', 'visible');
		break;
	case 2:
		document.getElementById('bottomSqlsTabDesignIF3').src="/Sqls/sqlsPerformanceCheckResult";
		$('#btn_sqlInfo_pop').css('visibility', 'hidden');
		break;
	case 3:
		loadSqlsProgramInfo();
...
function createSqlInfoPopup(){
	...
	$('#sqlInfoPop').window({
		...
		top:getWindowTop(650),
		left:getWindowLeft(1670)
	});
...
function createSqlPlanPerformanceCheck() {
	$("#sql_plan_performance_check").datagrid({
		...
		columns:[[
			...
			{field:'operation',title:'OPERATION',halign:"center",align:'left',width:'370px',formatter:toNbspFromWithespace,styler:diffStyle1},
...
function createSqlPlanOperation() {
	$("#sql_plan_operation").datagrid({
		...
		columns:[[
			...
			{field:'io_cost_percent',title:'IO_COST<br>(%)',halign:"center",align:'right',width:'63px',styler:cellStyler},
			{field:'id',title:'ID',halign:"center",align:'left',width:'25px'},
			{field:'operation',title:'OPERATION',halign:"center",align:'left',width:'370px',formatter:toNbspFromWithespace,styler:diffStyle2},
			{field:'cost',title:'COST',halign:"center",align:'right',width:'73px'},
			{field:'cpu_cost',title:'CPU_COST',halign:"center",align:'right',width:'73px'},
			{field:'io_cost',title:'IO_COST',halign:"center",align:'right',width:'73px'},
		]],
...
var callback_SqlTextPerformanceCheckAction = function(result) {
	try {
		...
		if(data.rows == null || data.rows.length == 0) {
			//$('#sql_text_performance_check').textbox('setValue', "검색된 데이터가 없습니다.");
			$('#sql_text_performance_check').val("검색된 데이터가 없습니다.");
		...
		$('#sql_text_performance_check').val(rows[0].program_source_desc);
		$('#sql_text_performance_check').height( $('#sql_text_performance_check').prop('scrollHeight') );
...
var callback_SqlBindPerformanceCheckAction = function(result) {
	try {
		...
		if(data.rows == null || data.rows.length == 0) {
			//$('#sql_bind_performance_check').textbox('setValue', "검색된 데이터가 없습니다.");
			$('#sql_bind_performance_check').val("검색된 데이터가 없습니다.");
		...
		$('#sql_bind_performance_check').val(bind);
	} catch(err) {
