...
function callData() {
	if($('#before_prd_sql_id').val() != '' && $('#before_prd_plan_hash_value').val() != '') {
		/* modal progress open */
		if(parent.openMessageProgress != undefined) parent.openMessageProgress($('#menu_nm').val(),"이전 운영 성능  추적 중");
	
		ajaxCall("/Sqls/beforeOperationPerformance",
				$("#submit_form"),
				"POST",
				callback_BeforeOperationPerformanceAction);
	} else {
		if($('#perf_check_id').val() != '' && $('#perf_check_step_id').val() != '' &&
			...
			ajaxCall("/Sqls/performanceCheck",
					$("#submit_form"),
					"POST",
...
function testCallData() {
	let sql_performance_trace_status_li_value_before_elapsed_time = '0.1';
	let sql_performance_trace_status_li_value_before_buffer_gets = '43';
	let sql_performance_trace_status_li_value_before_rows_processed = '100';
	let sql_performance_trace_status_li_value_before_sql_id = '431434321';
	let sql_performance_trace_status_li_value_before_plan_hash_value = '431434321';
	let sql_performance_trace_status_li_value_before_last_active_time = '2020-03-10 13:24';
	
	if(sql_performance_trace_status_li_value_before_elapsed_time) {
	...
	$('#sql_performance_trace_status_li_value_before_elapsed_time').html(sql_performance_trace_status_li_value_before_elapsed_time);
	$('#sql_performance_trace_status_li_value_before_buffer_gets').html(sql_performance_trace_status_li_value_before_buffer_gets);
	$('#sql_performance_trace_status_li_value_before_rows_processed').html(sql_performance_trace_status_li_value_before_rows_processed);
	$('#sql_performance_trace_status_li_value_before_sql_id').html(sql_performance_trace_status_li_value_before_sql_id);
	$('#sql_performance_trace_status_li_value_before_plan_hash_value').html(sql_performance_trace_status_li_value_before_plan_hash_value);
	$('#sql_performance_trace_status_li_value_before_last_active_time').html(sql_performance_trace_status_li_value_before_last_active_time);
	
	let sql_performance_trace_status_li_value_elapsed_time = '';
	let sql_performance_trace_status_li_value_buffer_gets = '';
	let sql_performance_trace_status_li_value_rows_processed = '';
	let sql_performance_trace_status_li_value_sql_id = '';
	let sql_performance_trace_status_li_value_plan_hash_value = '';
	let sql_performance_trace_status_li_value_program_exec_dt = '';
	let sql_performance_trace_status_li_value_deploy_complete_dt = '';
	
	$('#sql_performance_trace_status_li_value_elapsed_time').html(sql_performance_trace_status_li_value_elapsed_time);
	$('#sql_performance_trace_status_li_value_buffer_gets').html(sql_performance_trace_status_li_value_buffer_gets);
	$('#sql_performance_trace_status_li_value_rows_processed').html(sql_performance_trace_status_li_value_rows_processed);
	$('#sql_performance_trace_status_li_value_sql_id').html(sql_performance_trace_status_li_value_sql_id);
	$('#sql_performance_trace_status_li_value_plan_hash_value').html(sql_performance_trace_status_li_value_plan_hash_value);
	$('#sql_performance_trace_status_li_value_program_exec_dt').html(sql_performance_trace_status_li_value_program_exec_dt);
	$('#sql_performance_trace_status_li_value_deploy_complete_dt').html(sql_performance_trace_status_li_value_deploy_complete_dt);
	
	let sql_performance_trace_status_li_value_after_elapsed_time = '';
	let sql_performance_trace_status_li_value_after_buffer_gets = '';
	let sql_performance_trace_status_li_value_after_rows_processed = '';
	let sql_performance_trace_status_li_value_after_sql_id = '';
	let sql_performance_trace_status_li_value_after_plan_hash_value = '';
	let sql_performance_trace_status_li_value_after_last_active_time = '';
	let sql_performance_trace_status_li_value_after_elapsed_time_activity = '';
	let sql_performance_trace_status_li_value_after_buffer_gets_activity = '';
	
	$('#sql_performance_trace_status_li_value_after_elapsed_time').html(sql_performance_trace_status_li_value_after_elapsed_time);
	$('#sql_performance_trace_status_li_value_after_buffer_gets').html(sql_performance_trace_status_li_value_after_buffer_gets);
	$('#sql_performance_trace_status_li_value_after_rows_processed').html(sql_performance_trace_status_li_value_after_rows_processed);
	$('#sql_performance_trace_status_li_value_after_sql_id').html(sql_performance_trace_status_li_value_after_sql_id);
	$('#sql_performance_trace_status_li_value_after_plan_hash_value').html(sql_performance_trace_status_li_value_after_plan_hash_value);
	$('#sql_performance_trace_status_li_value_after_last_active_time').html(sql_performance_trace_status_li_value_after_last_active_time);
	$('#sql_performance_trace_status_li_value_after_elapsed_time_activity').html(sql_performance_trace_status_li_value_after_elapsed_time_activity);
	$('#sql_performance_trace_status_li_value_after_buffer_gets_activity').html(sql_performance_trace_status_li_value_after_buffer_gets_activity);
	
	let sql_performance_trace_status_li_value_after_prd_elap_time_increase_ratio = '10';
	let sql_performance_trace_status_li_value_after_prd_buffer_gets_increase_ratio = '0';
	let sql_performance_trace_status_li_value_after_prd_rows_proc_increase_ratio = '-10.28';
	
	$('#sql_performance_trace_status_li_value_after_prd_elap_time_increase_ratio').text(formattedRatio(sql_performance_trace_status_li_value_after_prd_elap_time_increase_ratio));
	$('#sql_performance_trace_status_li_value_after_prd_buffer_gets_increase_ratio').text(formattedRatio(sql_performance_trace_status_li_value_after_prd_buffer_gets_increase_ratio));
	$('#sql_performance_trace_status_li_value_after_prd_rows_proc_increase_ratio').text(formattedRatio(sql_performance_trace_status_li_value_after_prd_rows_proc_increase_ratio));
}

var callback_BeforeOperationPerformanceAction = function(result) {
	try {
		var data = JSON.parse(result);
		let row = parent.$("#tableList").datagrid('getSelected');
		
		if(typeof data != 'undefined' && data.length > 0) {
			let elapsed_time = row.before_prd_elapsed_time;
			let buffer_gets = row.before_prd_buffer_gets;
			let rows_processed = row.before_prd_rows_processed;
			...
			$('#sql_performance_trace_status_begin').css('color', '#000000');
			...
			$('#sql_performance_trace_status_li_value_before_elapsed_time').html(elapsed_time);
			$('#sql_performance_trace_status_li_value_before_buffer_gets').html(buffer_gets);
			$('#sql_performance_trace_status_li_value_before_rows_processed').html(rows_processed);
			$('#sql_performance_trace_status_li_value_before_sql_id').html(sql_id);
			$('#sql_performance_trace_status_li_value_before_plan_hash_value').html(plan_hash_value);
			$('#sql_performance_trace_status_li_value_before_last_active_time').html(last_active_time);
		}
	} catch(err) {
		parent.$.messager.alert('에러', '이전 운영 성능</br>' + err.message);
	} finally {
