...
function Btn_InsertGuide(){
	location.href="/PrecedentNew/Insert?menu_id="+$("#menu_id").val();
}

function getDetailView(){
	$("#submit_form").attr("action","/PrecedentNew/Update");
	$("#submit_form").submit();	
}
...
function Excel_DownClick(){	
	...
	$("#submit_form").attr("action","/PrecedentNew/ExcelDown");
	$("#submit_form").submit();
}
