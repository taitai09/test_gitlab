...
function Btn_OnClick(){
	...
	/* modal progress open */
	if(parent.openMessageProgress != undefined) parent.openMessageProgress("일 예방 점검 - ARCHIVE LOG SPACE"," "); 

	ajaxCall("/PreventiveCheck/ArchiveLogSpace",
			$("#submit_form"),
			"POST",
			callback_ArchiveLogSpaceAction);
}

//callback 함수
var callback_ArchiveLogSpaceAction = function(result) {
