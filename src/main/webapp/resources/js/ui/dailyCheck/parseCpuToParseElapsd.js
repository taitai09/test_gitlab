$(document).ready(function() {
	...
	$("#tableList").datagrid({
		...
		columns:[[
			...
			{field:'inst_efficiency_value',title:'PARSE_CPU_TO_PARSE_ELAPSED(%)',width:"25%",halign:"center",align:"right",sortable:"true"},
			{field:'threshold_value',title:'OPTIMAL_PARSE_CPU_THRESHOLD(%)',width:"25%",halign:"center",align:"right",sortable:"true"}
		]],
...
function Btn_OnClick(){
	...
	/* modal progress open */
	if(parent.openMessageProgress != undefined) parent.openMessageProgress("일 예방 점검 - PARSE CPU TO PARSE ELAPSD"," "); 

	ajaxCall("/PreventiveCheck/ParseCpuToParseElapsd",
			$("#submit_form"),
			"POST",
			callback_ParseCpuToParseElapsdAction);
}

//callback 함수
var callback_ParseCpuToParseElapsdAction = function(result) {
