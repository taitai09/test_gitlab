$(document).ready(function() {
	...
	$("#tableList").datagrid({
		...
		columns:[[
			...
			{field:'param_db_file_cnt',title:'PARAM_DB_FILE_CNT',width:"25%",halign:"center",align:"right",sortable:"true"},
			{field:'create_db_file_cnt',title:'CREATE_DB_FILE_CNT',width:"25%",halign:"center",align:"right",sortable:"true"},
			{field:'created_percent',title:'CREATED(%)',width:"25%",halign:"center",align:"right",sortable:"true"}
		]],
...
function Btn_OnClick(){
	...
	/* modal progress open */
	if(parent.openMessageProgress != undefined) parent.openMessageProgress("일 예방 점검 - DBFILES"," "); 

	ajaxCall("/PreventiveCheck/Dbfiles",
			$("#submit_form"),
			"POST",
			callback_DbfilesAction);
}

//callback 함수
var callback_DbfilesAction = function(result) {
