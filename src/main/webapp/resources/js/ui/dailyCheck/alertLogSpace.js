...
function Btn_OnClick(){
	...
	/* modal progress open */
	if(parent.openMessageProgress != undefined) parent.openMessageProgress("일 예방 점검 - ALERT LOG SPACE"," "); 

	ajaxCall("/PreventiveCheck/AlertLogSpace",
			$("#submit_form"),
			"POST",
			callback_AlertLogSpaceAction);
}

//callback 함수
var callback_AlertLogSpaceAction = function(result) {
