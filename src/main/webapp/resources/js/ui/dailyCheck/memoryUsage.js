$(document).ready(function() {
	...
	$("#tableList").datagrid({
		...
		columns:[[
			...
			{field:'inst_efficiency_value',title:'MEMORY_USAGE(%)',width:"25%",halign:"center",align:"right",sortable:"true"},
			{field:'threshold_value',title:'OPTIMAL_MEM_USAGE_THRESHOLD(%)',width:"25%",halign:"center",align:"right",sortable:"true"}
		]],
...
function Btn_OnClick(){
	...
	/* modal progress open */
	if(parent.openMessageProgress != undefined) parent.openMessageProgress("일 예방 점검 - MEMORY USAGE"," "); 

	ajaxCall("/PreventiveCheck/MemoryUsage",
			$("#submit_form"),
			"POST",
			callback_MemoryUsageAction);
}

//callback 함수
var callback_MemoryUsageAction = function(result) {
