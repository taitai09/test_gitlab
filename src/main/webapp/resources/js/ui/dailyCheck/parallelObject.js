...
$(document).ready(function() {
	...
	$("#tableList").datagrid({
		...
		columns:[[
			...
			{field:'partition_name',title:'PARTITION NAME',width:"8%",halign:"center",align:"center",sortable:"true"},
			{field:'subpartition_name',title:'SUBPARTITION NAME',width:"8%",halign:"center",align:"center",sortable:"true"},
...
function Btn_OnClick(){
	...
	/* modal progress open */
	if(parent.openMessageProgress != undefined) parent.openMessageProgress("일 예방 점검 - PARALLEL OBJECT"," "); 

	ajaxCall("/PreventiveCheck/ParallelObject",
			$("#submit_form"),
			"POST",
			callback_ParallelObjectAction);
}

//callback 함수
var callback_ParallelObjectAction = function(result) {
