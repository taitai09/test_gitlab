$(document).ready(function() {
	...
	$("#tableList").datagrid({
		...
		columns:[[
			...
			{field:'inst_efficiency_value',title:'BUFFER_CACHE_HIT(%)',width:"20%",halign:"center",align:"right",sortable:"true"},
...
function Btn_OnClick(){
	...
	/* modal progress open */
	if(parent.openMessageProgress != undefined) parent.openMessageProgress("일 예방 점검 - BUFFER CACHE HIT"," "); 

	ajaxCall("/PreventiveCheck/BufferCacheHit",
			$("#submit_form"),
			"POST",
			callback_BufferCacheHitAction);
}

//callback 함수
var callback_BufferCacheHitAction = function(result) {
