$(document).ready(function() {
	...
	$("#tableList").datagrid({
		...
		columns:[[
			...
			{field:'error_cd',title:'ERROR_CD',width:"20%",halign:"center",align:"left",sortable:"true"},
			{field:'error_cnt',title:'ERROR_CNT',width:"20%",halign:"center",align:"right",sortable:"true"}
...
function Btn_OnClick(){
	...
	/* modal progress open */
	if(parent.openMessageProgress != undefined) parent.openMessageProgress("일 예방 점검 - ALERT LOG ERROR"," "); 

	ajaxCall("/PreventiveCheck/AlertLogError",
			$("#submit_form"),
			"POST",
			callback_AlertLogErrorAction);
}

//callback 함수
var callback_AlertLogErrorAction = function(result) {
