$(document).ready(function() {
	...
	$("#tableList").datagrid({
		...
		columns:[[
			...
			{field:'inst_efficiency_value',title:'DISK_SORT(%)',width:"25%",halign:"center",align:"right",sortable:"true"},
			{field:'threshold_value',title:'OPTIMAL_DISK_SORT_THRESHOLD(%)',width:"25%",halign:"center",align:"right",sortable:"true"}
		]],
...
function Btn_OnClick(){
	...
	/* modal progress open */
	if(parent.openMessageProgress != undefined) parent.openMessageProgress("일 예방 점검 - DISK SORT"," "); 

	ajaxCall("/PreventiveCheck/DiskSort",
			$("#submit_form"),
			"POST",
			callback_DiskSortAction);
}

//callback 함수
var callback_DiskSortAction = function(result) {
