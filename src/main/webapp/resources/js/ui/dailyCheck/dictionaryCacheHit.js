$(document).ready(function() {
	...
	$("#tableList").datagrid({
		...
		columns:[[
			...
			{field:'inst_efficiency_value',title:'DICTIONARY_CACHE_HIT(%)',width:"20%",halign:"center",align:"right",sortable:"true"},
			{field:'threshold_value',title:'OPTIMAL_HIT_THRESHOLD(%)',width:"20%",halign:"center",align:"right",sortable:"true"}
		]],
...
function Btn_OnClick(){
	...
	/* modal progress open */
	if(parent.openMessageProgress != undefined) parent.openMessageProgress("일 예방 점검 - DICTIONARY CACHE HIT"," "); 

	ajaxCall("/PreventiveCheck/DictionaryCacheHit",
			$("#submit_form"),
			"POST",
			callback_DictionaryCacheHitAction);
}

//callback 함수
var callback_DictionaryCacheHitAction = function(result) {
