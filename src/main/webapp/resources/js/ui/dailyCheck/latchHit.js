$(document).ready(function() {
	...
	$("#tableList").datagrid({
		...
		columns:[[
			...
			{field:'inst_efficiency_value',title:'LATCH_HIT(%)',width:"20%",halign:"center",align:"right",sortable:"true"},
...
function Btn_OnClick(){
	...
	/* modal progress open */
	if(parent.openMessageProgress != undefined) parent.openMessageProgress("일 예방 점검 - LATCH HIT"," "); 

	ajaxCall("/PreventiveCheck/LatchHit",
			$("#submit_form"),
			"POST",
			callback_LatchHitAction);
}

//callback 함수
var callback_LatchHitAction = function(result) {
