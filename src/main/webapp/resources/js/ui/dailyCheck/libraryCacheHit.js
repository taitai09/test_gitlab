$(document).ready(function() {
	...
	$("#tableList").datagrid({
		...
		columns:[[
			...
			{field:'inst_efficiency_value',title:'LIBRARY_CACHE_HIT(%)',width:"20%",halign:"center",align:"right",sortable:"true"},
...
function Btn_OnClick(){
	...
	/* modal progress open */
	if(parent.openMessageProgress != undefined) parent.openMessageProgress("일 예방 점검 - LIBRARY CACHE HIT"," "); 

	ajaxCall("/PreventiveCheck/LibraryCacheHit",
			$("#submit_form"),
			"POST",
			callback_LibraryCacheHitAction);
}

//callback 함수
var callback_LibraryCacheHitAction = function(result) {
