...
//		url:"/Common/getWrkJob",
	...
	$('#perf_check_evaluation_meth_cd').combobox({
		...
		onLoadSuccess: function(){
			$("#perf_check_evaluation_meth_cd").combobox("setValue","1");
		}
	});
...
//				{field:'parsing_schema_name',title:'스키마',width:"10%",halign:"center",align:'center'},
				...
				{field:'perf_check_evaluation_meth_nm',title:'점검평가방법',width:"10%",halign:"center",align:'center'},
