$(document).ready(function() {
	...
	$("#tableList").datagrid({
		...
		columns:[[
			...
			{field:'start_snap_no',title:'시작스냅샷번호',halign:"center",align:'center',sortable:"true"},
			{field:'end_snap_no',title:'종료스냅샷번호',halign:"center",align:'center',sortable:"true"},
...
//	$("#snapShot_form #strStartDt").datebox("setValue", startDate);
//	$("#snapShot_form #strEndDt").datebox("setValue", nowDate);		
	$("#snapShot_form #strStartDt").datebox("setValue", parent.startDate);
	$("#snapShot_form #strEndDt").datebox("setValue", parent.nowDate);		
