		...
		onSelect: function(title,index){
			...
			case 0:
				...
				if(operationDesignIF1Src == undefined || operationDesignIF1Src == ""){
					document.getElementById('operationDesignIF1').src="/sqlStandardOperationDesign/QualityReviewWork";
				}
			...
			case 1:
				...
				if(operationDesignIF22Src == undefined || operationDesignIF22Src == ""){
					document.getElementById('operationDesignIF2').src="/sqlStandardOperationDesign/LoadQualityTable";
				}
			...
			case 2:
				...
				if(operationDesignIF3Src == undefined || operationDesignIF3Src == ""){
					document.getElementById('operationDesignIF3').src="/sqlStandardOperationDesign/MaintainQualityCheckException";
				}
