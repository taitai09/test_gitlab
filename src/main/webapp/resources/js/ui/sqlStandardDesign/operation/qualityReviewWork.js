...
function showLoadSqlProjectUnitPop(){
	...
	$('#loadSQLProjectUnit_form #project_nm').textbox('setValue', $('#submit_form #project_nm').textbox('getValue'));
	$('#loadSQLProjectUnit_form #project_id').val($('#submit_form #project_id').val());
