$(document).ready(function() {
	...
	$("#tableList").datagrid({
		...
		columns:[[
			...
			{field:'avg_elapsed_time',title:'AVG_ELAPSED_TIME',halign:"center",align:'right',sortable:"true",formatter:getNumberFormat},
			{field:'offload_yn',title:'OFFLOAD_YN',halign:"center",align:'right',sortable:"true"},
			{field:'io_saved',title:'IO_SAVED(%)',halign:"center",align:'right',sortable:"true",formatter:getNumberFormat},
			{field:'before_1_week_io_saved ',title:'일주일전 IO_SAVED(%)',halign:"center",align:'right',sortable:"true",formatter:getNumberFormat},
			{field:'io_saved_decrease',title:'IO_SAVED 감소량(%)',halign:"center",align:'right',sortable:"true", formatter:getNumberFormat},
...
function Btn_OnClick(){
	...
	/* modal progress open */
	if(parent.openMessageProgress != undefined) parent.openMessageProgress("SQL 진단 - OFFLOAD 효율저하 SQL"," "); 

	ajaxCall("/SQLDiagnostics/OffloadEffcReduceSql",
		$("#submit_form"),
		"POST",
		callback_OffloadEffcReduceAddTable);		
}

//callback 함수
var callback_OffloadEffcReduceAddTable = function(result) {
