$(document).ready(function() {
	...
	$("#tableList").datagrid({
		...
		columns:[[
			...
			{field:'sql_cnt',title:'COUNT',width:"8%",halign:"center",align:'right',sortable:"true"},
			{field:'gather_day',title:'기준일자',width:"12%",halign:"center",align:'center',formatter:getDateFormat,sortable:"true"},
...
function Btn_OnClick(){
	...
	/* modal progress open */
	if(parent.openMessageProgress != undefined) parent.openMessageProgress("SQL 진단 - Literal SQL[SQL TEXT 기반]"," "); 
	
	ajaxCall("/SQLDiagnostics/LiteralSQL",
		$("#submit_form"),
		"POST",
		callback_LiteralSQLAction);
}

//callback 함수
var callback_LiteralSQLAction = function(result) {
