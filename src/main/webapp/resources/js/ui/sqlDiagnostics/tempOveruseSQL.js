$(document).ready(function() {
	...
	$("#tableList").datagrid({
		...
		columns:[[
			...
			{field:'temp_usage',title:'TEMP USAGE(GB)',halign:"center",align:'right',sortable:"true"},
			{field:'command_type',title:'COMMAND_TYPE',halign:"center",align:'right',sortable:"true"},
...
function Btn_OnClick(){
	...
	/* modal progress open */
	if(parent.openMessageProgress != undefined) parent.openMessageProgress("SQL 진단 - TEMP 과다사용 SQL"," "); 
	
	ajaxCall("/SQLDiagnostics/TempOveruseSQL",
		$("#submit_form"),
		"POST",
		callback_TempOveruseSQLAddTable);		
}

//callback 함수
var callback_TempOveruseSQLAddTable = function(result) {
