$(document).ready(function() {
	...
	$("#tableList").datagrid({
		...
		columns:[[
			...
			{field:'operations',title:'OPERATIONS',halign:"center",align:'left',sortable:"true"},
...
function Btn_OnClick(){
	...
	/* modal progress open */
	if(parent.openMessageProgress != undefined) parent.openMessageProgress("SQL 진단 - FULLSCAN SQL"," "); 

	ajaxCall("/SQLDiagnostics/FullScan",
		$("#submit_form"),
		"POST",
		callback_FullScanAddTable);		
}

//callback 함수
var callback_FullScanAddTable = function(result) {
...
function Btn_ExceptionList(){
	parent.$.messager.defaults.ok = '확인';
	parent.$.messager.alert('제외대상 리스트',$("#exception_list").val());
