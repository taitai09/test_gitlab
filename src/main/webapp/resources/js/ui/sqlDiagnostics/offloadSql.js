$(document).ready(function() {
	...
	$("#tableList").datagrid({
		...
		columns:[[
			...
			{field:'parallel_servers',title:'PARALLEL_SERVERS',halign:"center",align:'right',sortable:"true",formatter:getNumberFormat},
			...
			{field:'rank_elapsed_time',title:'RANK_ELAPSED_TIME',halign:"center",align:'right',sortable:"true", formatter:getNumberFormat},
...
function Btn_OnClick(){
	...
	/* modal progress open */
	if(parent.openMessageProgress != undefined) parent.openMessageProgress("SQL 진단 - OFFLOAD 비효율 SQL"," "); 

	ajaxCall("/SQLDiagnostics/OffloadSql",
		$("#submit_form"),
		"POST",
		callback_OffloadSqlAddATable);		
}

//callback 함수
var callback_OffloadSqlAddATable = function(result) {
