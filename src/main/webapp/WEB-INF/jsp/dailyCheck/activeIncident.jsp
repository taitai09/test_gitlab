...
<html lang="ko">
<head>
	<title>일 예방 점검 - ACTIVE INCIDENT</title>
	<meta charset="utf-8" />
...
<div id="container">	
	...
	<form:form method="post" id="submit_form" name="submit_form" class="form-inline">
		...
		<div id="contents">
			...
			<div class="tbl_title" style="margin-bottom:10px;"><span class="h3"><i class="btnIcon fab fa-wpforms fa-lg fa-fw"></i> PROBLEM</span></div>
			<div class="easyui-panel" data-options="border:false" style="width:100%;min-height:300px;">
				<table id="problemTableList" class="tbl easyui-datagrid" data-options="fit:true,border:false">
				</table>
			</div>
			<div class="tbl_title" style="margin-bottom:10px;"><span class="h3"><i class="btnIcon fab fa-wpforms fa-lg fa-fw"></i> INCIDENT</span></div>
			<div class="easyui-panel" data-options="border:false" style="width:100%;min-height:300px;">
				<table id="incidentTableList" class="tbl easyui-datagrid" data-options="fit:true,border:false">
				</table>
			</div>
		</div>
	</form:form>			
