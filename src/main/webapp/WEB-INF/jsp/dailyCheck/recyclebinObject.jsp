...
<html lang="ko">
<head>
	<title>일 예방 점검 - RECYCLEBIN OBJECT</title>
	<meta charset="utf-8" />
			...
			<div class="easyui-layout" data-options="border:false" style="width:100%;min-height:650px">
				<div data-options="region:'north',split:false,border:false" style="height:40px;">
					<div style="float:left;width:250px;margin-top:5px;">
						<b><i class="btnIcon far fa-caret-square-right fa-lg fa-fw"></i> 오브젝트 갯수 :</b> <span id="objectCnt" style="font-weight:700;"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<b><i class="btnIcon far fa-caret-square-right fa-lg fa-fw"></i> 사이즈 :</b> <span id="objectSize" style="font-weight:700;"></span>
					</div>
				</div>
