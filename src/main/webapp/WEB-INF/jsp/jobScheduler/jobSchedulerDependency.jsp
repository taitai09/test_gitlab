...
<html lang="ko">
<head>
	<title>설정 :: 스케쥴러 설정 :: 작업스케쥴러 종속관계 관리</title>
	<meta charset="utf-8" />
    ...
    <script type="text/javascript" src="/resources/js/ui/jobScheduler/jobSchedulerDependency.js?ver=<%=today%>"></script>
</head>
			...
			<div class="well">
				<form:form method="post" id="submit_form" name="submit_form" class="form-inline">
					...
					<select id="searchKey" name="searchKey" data-options="panelHeight:'auto',editable:false" class="w150 easyui-combobox">
						...
						<option value="02">종속작업스케쥴러 유형</option>
						<option value="03">종속작업스케쥴러 상세유형</option>
					</select>
...
<!-- 					</select> -->
		...
		<div class="easyui-panel" data-options="border:false" style="width:100%;min-height:320px">
			<form:form method="post" id="detail_form" name="detail_form" class="form-inline">
				...
				<input type="hidden" id="job_scheduler_type_cd_nm" name="dpnd_job_sched_type_cd_nm" />
				<input type="hidden" id="dpnd_job_sched_type_nm" name="dpnd_job_sched_type_nm" />
				<input type="hidden" id="dpnd_job_sched_detail_type_nm" name="dpnd_job_sched_detail_type_nm" />
				
				<input type="hidden" id="old_dpnd_job_sched_type_cd" name="old_dpnd_job_sched_type_cd" />
				<input type="hidden" id="old_dpnd_job_sched_detail_type_cd" name="old_dpnd_job_sched_detail_type_cd" />
				<input type="hidden" id="old_dpnd_job_sched_detail_type_nm" name="old_dpnd_job_sched_detail_type_nm" />
				...
				<table class="detailT">
					...
					<tr>
						...
						<th>종속작업 스케쥴러 유형</th>
						<td>
							<select id="dpnd_job_sched_type_cd" name="dpnd_job_sched_type_cd" data-options="panelHeight:'150',editable:false" class="w200 easyui-combobox" required></select>
						</td>
						<th>종속작업 스케쥴러 상세유형</th>

						<td>
							<select id="dpnd_job_sched_detail_type_cd" name="dpnd_job_sched_detail_type_cd" data-options="panelHeight:'150',editable:false" class="w200 easyui-combobox" required></select>
<!-- 							<input type="text" id="dpnd_job_sched_detail_type_cd" name="dpnd_job_sched_detail_type_cd" class="w150 easyui-textbox"/> -->
						</td>
					</tr>
				</table>
