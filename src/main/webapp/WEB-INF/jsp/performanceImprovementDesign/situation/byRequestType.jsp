...
<html lang="ko">
<head>
	<title>성능 리포트 :: 요청유형별 성능개선현황</title>
	<meta charset="utf-8" />
    ...
    <script type="text/javascript" src="/resources/js/ui/performanceImprovementDesign/situation/byRequestType.js?ver=<%=today%>"></script>
</head>
