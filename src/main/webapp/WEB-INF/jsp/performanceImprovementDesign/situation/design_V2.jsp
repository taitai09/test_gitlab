...
<head>
	...
	<script type="text/javascript" src="/resources/js/ui/performanceImprovementDesign/situation/design_V2.js?ver=<%=today%>"></script>
	<style>
		.tabs-header{
			...
			<div id="situationDesignTab" class="easyui-tabs" data-options="fit:true,border:false">
				<div title="성능개선결과 산출물" data-options="fit:true" style="padding:5px;min-height:690px;">
					<iframe id="situationDesignIF2" name="situationDesignIF2" frameborder="0" framespacing="0" marginheight="0" marginwidth="0" scrolling="no" vspace="0" 
							src="/PerformanceImprovementDesign/PerformanceImprovementOutputs_V2?menu_id=${menu_id}" style="width:100%;min-height:690px;">
					</iframe>
				</div>
				
<!-- 				<div title="성능개선결과 산출물" data-options="fit:true" style="padding:5px;min-height:680px;"> -->
<!-- 					<iframe id="situationDesignIF2" name="situationDesignIF2" frameborder="0" framespacing="0" marginheight="0" marginwidth="0" scrolling="no" vspace="0"  -->
