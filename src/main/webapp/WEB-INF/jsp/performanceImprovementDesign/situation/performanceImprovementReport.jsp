...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/performanceImprovementDesign/situation/performanceImprovementReport.js?ver=<%=today%>"></script>
</head>
		...
		<div class="easyui-panel searchArea" data-options="border:false" style="width:100%">
			<div class="well">
				<form:form method="post" id="submit_form" name="submit_form" class="form-inline">
					...
					<label>요청일자</label>
					<input type="text" id="strStartDt" name="strStartDt" value="${perfList.strStartDt}" data-options="panelHeight:'auto',editable:false" class="w130 datapicker easyui-datebox"/>
					<input type="text" id="strEndDt" name="strEndDt" value="${perfList.strEndDt}" data-options="panelHeight:'auto',editable:false" class="w130 datapicker easyui-datebox"/>
					<label>프로젝트</label>
...
<!-- 			<a href="javascript:;" class="w80 easyui-linkbutton" onClick="Excel_DownClick();"><i class="btnIcon fas fa-file-excel fa-lg fa-fw"></i> 엑셀</a> -->
<!-- 		</div>		 -->
		<div class="easyui-panel" data-options="border:false" style="width:100%;min-height:575px;">
