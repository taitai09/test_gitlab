...
<head>
	...
	<script type="text/javascript" src="/resources/js/ui/examineOpenPOP/examineOpenPOPDesign2.js?ver=<%=today%>"></script>
	<style>
		.tabs-header{
	...
	<div id="contents">
		...
		<div class="easyui-panel" data-options="border:false" style="width:100%;min-height:730px">
			...
			<div id="examineOpenPOPDesignTab" class="easyui-tabs" data-options="fit:true,border:false">
				<div title="Agent 점검" data-options="fit:true" style="padding-top:5px;min-height:720px;">
					<iframe id="examineOpenPOPDesignIF1" name="examineOpenPOPDesignIF1" frameborder="0" framespacing="0" marginheight="0" marginwidth="0" scrolling="no" vspace="0" 
							src="/ExamineOpenPOP/examineAgent2" style="width:100%;min-height:700px;"></iframe>
				</div>
				<div title="Scheduler 점검" data-options="fit:true" style="padding-top:5px;min-height:680px;border-bottom:1px solid lightgray">
