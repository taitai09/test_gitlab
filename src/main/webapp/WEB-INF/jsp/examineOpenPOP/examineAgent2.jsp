...
<head>
	...
	<script type="text/javascript" src="/resources/js/ui/examineOpenPOP/examineAgent2.js?ver=<%=today%>"></script>
</head>
...
<div id="container">
	<!-- contents START -->
	<div id="contents">
		<div class="easyui-layout" data-options="border:false" style="width:70%;height:720px;">
			<div data-options="region:'north',split:false,collapsible:false,border:false" style="height:50px;padding:0px;">
				<div class="well">
				...
				<div class="easyui-layout" data-options="border:false" style="width:100%;min-height:630px;">
					<div title="Open-POP 서버" data-options="region:'west',split:false,collapsible:false,border:true" style="width:30%;padding:5px;">
						<div class="easyui-layout" data-options="border:false" style="width:100%;height:100%;">
							...
							<div class="easyui-panel" data-options="border:false" style="height:100%;margin-bottom:10px;">
