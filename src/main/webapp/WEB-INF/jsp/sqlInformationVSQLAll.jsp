...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/sqlInformationVSQLAll.js?ver=<%=today%>"></script>
    <style>
	.tree-node {
	  cursor: default;
	}
...
<body>
	<form:form method="post" id="submit_form" name="submit_form" class="form-inline">
		...
		<input type="hidden" id="sqlYnType" name="sqlYnType" value="${odsHistSqlText.rcount}"/>
...
<!-- 		<div class="easyui-layout" style="width:100%;height:600px;"> -->
		<c:choose>
			...
			<div data-options="region:'west',border:false" style="width:45%;height:80%;padding:5px 5px 5px 0px;">
...
<!-- 						<textarea name="textArea" id="textArea" style="margin-top:5px;padding:5px;width:97%;height:82%" wrap="off" readonly></textarea> -->
						<textarea name="textArea" id="textArea" style="margin-top:5px;padding:5px 0px;width:99%;height:75%" wrap="off" readonly></textarea>
			...
			<div data-options="region:'center',split:false,border:false" style="padding:5px 0px;">
				<div class="easyui-tabs" data-options="plain:true,fit:true,border:false">
...
<!-- 						<table id="bindValueList" class="tbl easyui-datagrid" data-options="border:false" style="width:100%;height:88%;"> -->
						<table id="bindValueList" class="tbl easyui-datagrid" data-options="border:false" style="width:100%;height:85%;">
							<tbody><tr></tr></tbody>
						</table>
						<div class="searchBtn" style="margin-top:10px; margin-right:0px;">
							<a href="javascript:;" id="bindBtn" class="w80 easyui-linkbutton" data-options="" onClick="Btn_NextBindSearch();"> <i class="btnIcon fas fa-arrow-alt-circle-right fa-lg fa-fw"> </i> 다음</a>
						</div>
					</div>
...
<!-- 			<div data-options="region:'south',split:false,border:false" style="width:100%;height:40%;padding:5px;"> -->
			<div data-options="region:'south',split:false,border:false" style="width:100%;height:52%;padding:0px;">
				<table id="bottomList" class="tbl easyui-datagrid" data-options="border:false" style="width:100%;height:83%;">
				</table>
				<div class="searchBtn" style="margin-top:5px; margin-right:0px;">
					<a href="javascript:;" id="historyBtn" class="w80 easyui-linkbutton" style="margin-right:0px;" data-options="" onClick="Btn_NextHistorySearch();"> <i class="btnIcon fas fa-arrow-alt-circle-right fa-lg fa-fw"> </i> 다음</a>
				</div>	
			</div>
		</div>
	</form:form>
