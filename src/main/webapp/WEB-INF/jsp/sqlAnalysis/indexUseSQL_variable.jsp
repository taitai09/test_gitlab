...
<div id="indexUseSLQ" class="easyui-layout" data-options="border:false" style="width:100%;height:100%;">
	<div class="searchAreaSingle" data-options="border:false">
		<div class="well">
			...
			<span class="searchBtnLeft">
				<a href="javascript:;" class="w80 easyui-linkbutton" onClick="Btn_OnClickIndex();"><i class="btnIcon fas fa-search fa-lg fa-fw"></i> 검색</a>
			</span>
			<div class="searchBtn innerBtn">
				<a href="javascript:;" class="w80 easyui-linkbutton" onClick="Excel_DownClickIndex();"><i class="btnIcon fas fa-file-excel fa-lg fa-fw"></i> 엑셀</a>
			</div>
		</div>
	</div>
	<div data-options="border:false" style="width:100%;min-height:640px;">
		<div id="indexUseTabs" class="easyui-tabs tableBorder-zero tableHeight" data-options="plain:true,fit:true,border:false" style="width:100%;">
