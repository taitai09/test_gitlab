...
<html lang="ko">
<head>
	<title>SQL 성능 분석 - SQL Access Advisor</title>
	<meta charset="utf-8" />
    ...
    <script type="text/javascript" src="/resources/js/ui/sqlAnalysis/sqlPerformance/sqlAccessAdvisor.js?ver=<%=today%>"></script>
    <script>
