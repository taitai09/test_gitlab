...
<html lang="ko">
<head>
	<title>성능 점검 :: 성능 점검 지표 관리 :: 성능 점검 지표 관리</title>
	<meta charset="utf-8" />
    ...
    <script type="text/javascript" src="/resources/js/ui/performanceCheckIndex/deployPerfChkIndc.js?ver=<%=today%>"></script>
</head>
...
<!-- 				<input type="hidden" id="perf_check_meth_cd" name="perf_check_meth_cd" /> -->
				...
				<table class="detailT">
					...
					<tr>
						<th>점검 지표</th>
						<td>
							<input type="text" id="perf_check_indc_nm" name="perf_check_indc_nm" class="w200 easyui-textbox"/>
						</td>	
						<th>점검 방법</th>
							<td>
								<select id="perf_check_meth_cd" name="perf_check_meth_cd" data-options="panelHeight:'auto',editable:false" class="w150 easyui-combotree"></select>
							</td>
						<th>사용여부</th>
							<td>
								<select id="indc_use_yn" name="indc_use_yn" data-options="panelHeight:'auto',editable:false" class="w150 easyui-combobox">
					...
					<tr>
						<th >지표 설명</th>
							<td colspan="5"><textarea id="perf_check_indc_desc" name="perf_check_indc_desc" style="width:100%;height:80px" ></textarea></td>
					</tr>
					<tr>
						<th>부적합 가이드</th>
							<td colspan="5"><textarea id="perf_check_fail_guide_sbst" name="perf_check_fail_guide_sbst" style="width:100%;height:80px" ></textarea></td>
					</tr>
				</table>
