...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/performanceCheckIndexDesign/situation/perfCheckState.js?ver=<%=today%>"></script>
...
<div id="container">	
	...
	<div id="contents">
		...
		<div title="CM 점검 현황" style="border:0px;">
		...
		<div title="프로그램 점검 현황">
			...
			<div title="성능 점검 예외 처리 현황">
				<div class="easyui-panel searchArea" data-options="border:false" style="width:100%;">
					<div class="title" style="border:0px;">
						<span id="sub_title" class="h3">▶ 성능 점검 예외 처리 현황</span>
					</div>
					<div class="well">
			...
			<div title="성능 점검 예외 처리 사유별 현황">
				<div class="easyui-panel searchArea" data-options="border:false" style="width:100%;">
					<div class="title" style="border:0px;">
						<span id="sub_title" class="h3">▶ 성능 점검 예외 처리 사유별 현황</span>
					</div>					
					<div class="well">
