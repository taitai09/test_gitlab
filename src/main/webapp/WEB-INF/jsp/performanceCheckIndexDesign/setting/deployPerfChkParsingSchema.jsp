...
<html lang="ko">
<head>
	<title>성능 점검 :: 성능 점검 단계 관리 :: 업무별 파싱 스키마 관리</title>
	<meta charset="utf-8" />
    ...
    <script type="text/javascript" src="/resources/js/ui/performanceCheckIndexDesign/setting/deployPerfChkParsingSchema.js?ver=<%=today%>"></script>
</head>
			...
			<form:form method="post" id="detail_form" name="detail_form" class="form-inline">
				...
				<table class="detailT">
					...
					<tr>
						<th>업무</th>
							<td>
								<select id="wrkjob_cd" name="wrkjob_cd" data-options="panelHeight:'200px',editable:true" class="w150 easyui-combotree" required="required">
								</select>	
							</td>
						<th>점검 단계</th>
							<td>
					...
					<tr>
						...
						<th>스키마</th>
							<td>
								<select id="parsing_schema_name" name="parsing_schema_name" data-options="panelHeight:'auto',editable:false" class="w150 easyui-combobox" required="required">
								</select>
							</td>
					</tr>
				</table>
