...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/performanceCheckIndexDesign/setting/deployPerfChkStepTestDB.js?ver=<%=today%>"></script>
</head>
			...
			<form:form method="post" id="detail_form" name="detail_form" class="form-inline">
				...
				<table class="detailT">
					...
					<tr>
						<th>점검평가방법</th>
						<td>
							<select id="perf_check_evaluation_meth_cd" name="perf_check_evaluation_meth_cd" data-options="panelHeight:'auto',editable:false" class="w150 easyui-combobox" readonly="readonly"/>
							</select>
						</td>
						<th>DB</th>
						<td>
