...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/mqmDesign/setting/businessClassMng.js?ver=<%=today%>"></script>
		...
		<div class="easyui-panel" data-options="border:false" style="width:100%;min-height:300px">
			<form:form method="post" id="detail_form" name="detail_form" class="form-inline">
				...
				<table class="detailT">
					...
					<tr>
						<th>주제영역설명</th>
						<td colspan="3"><input id="biz_desc" name="biz_desc" rows="30" data-options="multiline:true" class="easyui-textbox" style="width:100%;height:40px"></td>
					</tr>
					<tr>
						<th>비고</th>
						<td colspan="3"><input id="remark" name="remark" rows="30" data-options="multiline:true" class="easyui-textbox" style="width:100%;height:40px" ></td>
					</tr>
				</table>
