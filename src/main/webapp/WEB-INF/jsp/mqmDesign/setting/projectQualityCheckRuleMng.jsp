...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/mqmDesign/setting/projectQualityCheckRuleMng.js?ver=<%=today%>"></script>    
</head>
...
<!-- 					<input type="text" id="project_nm" name="project_nm" value="" class="w350 easyui-textbox"/> -->
		...
		<div class="easyui-panel" data-options="border:false" style="width:100%;padding-left:5px;min-height:180px;margin-bottom:10px;">
		...
		<div class="easyui-panel" data-options="border:false" style="width:100%;min-height:300px">
			<form:form method="post" id="detail_form" name="detail_form" class="form-inline">
				...
				<table class="detailT">
					...
					<th>품질점검내용</th>
						<td colspan="5">
							<input id="qty_chk_cont" name="qty_chk_cont" rows="30" data-options="multiline:true" class="easyui-textbox" style="width:100%;height:50px" ></textarea>
						</td>
					</tr>
					<tr>
					<th>해결방안내용</th>
					...
					<tr>
						<th>품질점검 RULE
							<br/>
							<a href="javascript:;" class="w60 easyui-linkbutton" onClick="copy_to_clipboard();" style="height:20px;">RULE 복사</a>
						</th>
						<td colspan="5" style="vertical-align:top;">
							<textarea name="qty_chk_sql" id="qty_chk_sql" rows
							="10" cols="350" style="overlow:scroll;margin-top:3px;padding:5px;width:98%;height:108px;" wrap="off"></textarea>
						</td>
					</tr>
				</table>
