...
<head>
	...
	<script type="text/javascript" src="/resources/js/ui/autoPerformanceCompareBetweenDatabase/autoPerformanceCompareBetweenDatabaseDesign_V2.js"></script>
</head>
<body>
<div id="container">
	<div id="contents">
		...
		<div class="easyui-panel" data-options="border:false" style="width:100%;min-height:730px">
			<div id="autoPerformanceCompareBetweenDatabaseTab_V2" class="easyui-tabs" data-options="fit:true,border:false">
				
				<div title="성능영향도분석고도화" data-options="fit:true" style="padding-top:5px;">
