...
<head>
	...
	<script type="text/javascript" src="/resources/js/ui/autoPerformanceCompareBetweenDatabase/tuningSqlBatchVerify.js?ver=<%=today%>"></script>
						...
						<tr height="30px;">
							<td colspan="2" class="well placeholderColorChange" style="padding-top:10px; border:1px solid #eaeaea;">
								<table style="width:100%;">
									<tr height="30px;">
										<td style="width:120px;" align="left"><label>ASIS 대비 성능저하</label></td>
										<td align="left">
