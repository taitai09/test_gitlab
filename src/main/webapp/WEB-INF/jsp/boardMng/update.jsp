...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/boardMng/update.js?ver=<%=today%>"></script>    
</head>
<body>
		<!-- container START -->
<div id="container">	
	...
	<div id="contents">
		<div class="easyui-panel detailArea" data-options="border:false" style="width:100%;">
			<div class="title">
				<span class="h3"><i class="far fa-check-square fa-lg fa-fw"></i> ${boardManagement.board_nm} 수정</span>
			...
			<form:form method="post" id="submit_form" name="submit_form" class="form-inline" enctype="multipart/form-data">
				...
				<table class="detailT">
					...
					<tr>
						<th>제목</th>
						<td>
							<input type="text" id="title" name="title" value="${result.title}" class="easyui-textbox" style="width:500px;"/>
					...
					<c:choose>
						<c:when test="${boardManagement.file_add_yn eq 'Y'}">
							<tr>
								<th>첨부파일</th>
								<td>
									<input id="uploadFile" name="uploadFile" class="easyui-filebox" data-options="prompt:'파일을 선택해 주세요.'" style="width:50%"/>
