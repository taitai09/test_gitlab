...
<html lang="ko">
<head>
	<title>시스템관리 :: 게시판 관리 :: 게시물 답변</title>
	<meta charset="utf-8" />
    ...
    <script type="text/javascript" src="/resources/js/ui/boardMng/reply.js?ver=<%=today%>"></script>    
</head>
<body>
<!-- container START -->
<div id="container">	
	...
	<div id="contents">
		<div class="easyui-panel detailArea" data-options="border:false" style="width:100%;">
			<div class="title">
				<span class="h3"><i class="far fa-check-square fa-lg fa-fw"></i> ${boardManagement.board_nm} 답변</span>
		...
		<div class="dtlBtn" style="margin-bottom:10px;">
			<a href="javascript:;" class="w90 easyui-linkbutton" onClick="Btn_OnClick();"><i class="btnIcon fas fa-edit fa-lg fa-fw"></i> 답글 등록</a>						
