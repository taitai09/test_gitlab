...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/indexDesignAdviser/autoLoadIndexDesign.js?ver=<%=today%>"></script>
    <style>
		...
		<div class="easyui-panel searchAreaMulti" data-options="border:false" style="width:100%">
			...
			<form:form method="post" id="submit_form" name="submit_form" class="form-inline">
				...
				<div id="blockAutoLoadIndex" style="padding-top:5px;">
					...
					<span>
						<i id="col_null_tooltip" class="fas fa_question_circle easyui-tooltip" position="top"></i>
					</span>
					<span class="searchBtnLeft">
