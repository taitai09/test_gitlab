...
<html lang="ko">
<head>
	<title>성능분석 :: 오브젝트 분석 :: 인덱스 사용 SQL 내역</title>
	<meta charset="utf-8" />
    ...
    <script type="text/javascript" src="/resources/js/ui/objectAnalysis/indexUseSQL.js?ver=<%=today%>"></script>
</head>
<body>
<!-- container START -->
<div id="container">	
		...
		<div class="easyui-panel searchArea" data-options="border:false" style="width:100%">
			...
			<div class="well">
				<form:form method="post" id="submit_form" name="submit_form" class="form-inline">
					...
					<input type="text" id="index_name" name="index_name" class="w130 easyui-textbox"/>
