...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/precedentNew/precedentList.js?ver=<%=today%>"></script>
</head>
		...
		<div class="easyui-panel" data-options="border:false" style="width:100%;padding-left:5px;min-height:730px">
			<div id="sqlTuningTab" class="easyui-tabs" data-options="fit:true,border:false">
				...
				<%-- 					<input type="hidden" id="pagePerCount" name="pagePerCount" value="${perfGuide.pagePerCount}"/> --%>
									...
									<label>튜닝사례유형</label>
									<select id="tuning_case_type_cd" name="tuning_case_type_cd" data-options="panelHeight:'auto',editable:false" class="w100 easyui-combobox"></select>
