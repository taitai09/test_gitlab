...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/schedule/insert.js?ver=<%=today%>"></script>    
</head>
<body>
<!-- container START -->
<div id="container">	
	...
	<div id="contents">
		...
		<div class="easyui-panel" data-options="border:false" style="width:100%;padding-bottom:20px;">
			<form:form method="post" id="submit_form" name="submit_form" class="form-inline">
				...
				<input type="hidden" id="sched_type_cd" name="sched_type_cd"/>
				...
				<table class="detailT">
					...
					<tr>
						<th>제목</th>
						<td>
							<input type="text" id="sched_title" name="sched_title" class="easyui-textbox" style="width:98%;"/>
						</td>
					</tr>
					<tr>
						<th>일정</th>
						<td>
							<input type="text" id="sched_start_date" name="sched_start_date" value="${startDate}" class="w130 datapicker easyui-datebox"/>
							<input type="text" id="sched_start_time" name="sched_start_time" value="${nowTime}" class="w100 datatime easyui-timespinner"/> ~
							~
							<input type="text" id="sched_end_date" name="sched_end_date" value="${endDate}" class="w130 datapicker easyui-datebox"/>
							<input type="text" id="sched_end_time" name="sched_end_time" value="${nowTime}" class="w100 datatime easyui-timespinner"/>
						</td>
					</tr>
					<tr>
						<th>내용</th>
						<td style="padding-top:5px;padding-bottom:5px;"><textarea id="sched_sbst" name="sched_sbst" rows="20" style="width:97%; padding:15px;IME-MODE:active;"></textarea></td>
					</tr>
				</table>
			</form:form>
		</div>
		<div class="dtlBtn" style="margin-bottom:10px;">
			<a href="javascript:;" class="w90 easyui-linkbutton" onClick="Btn_OnClick();"><i class="btnIcon fas fa-edit fa-lg fa-fw"></i> 일정 등록</a>						
