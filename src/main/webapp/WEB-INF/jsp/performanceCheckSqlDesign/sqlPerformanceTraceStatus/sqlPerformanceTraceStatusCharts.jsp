...
<head>
	...
	<script type="text/javascript" src="/resources/js/ui/performanceCheckSqlDesign/sqlPerformanceTraceStatus/sqlPerformanceTraceStatusCharts.js?ver=<%=today%>"></script>
</head>
		...
		<div id="contents">
			...
			<div class="easyui-layout" data-options="border:false" style="width:100%;height:560px;border-bottom:1px solid;border-left:1px solid lightgray;overflow-y:auto;">
				<table style="width:100%;height:300px;border-right:1px solid lightgray;margin-top:0px;" class="detailT4">
					...
					<thead>
						<tr>
							<th colspan="2" style="height: 20px;">Buffer Gets</th>
							<th colspan="2" style="height: 20px;">Elapsed Time</th>
							<th id="planChange" colspan="2" style="height: 20px;">Plan 변경</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td colspan="2">
								<div id="chartPC" title="" style="width: 100%;height: 100%;padding-top: 0px;"></div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div id="chartPCPie" title="" style="width: 100%;height: 100%;padding-top: 0px;"></div>
							</td>
							<td style="border-left: 1px solid #FFF;">
								<div id="chartPCBar" title="" style="width: 100%;height: 100%;padding-top: 0px;"></div>
							</td>
						</tr>
					</tbody>
				</table><br><br>
				<table style="width:100%;height:300px;border-right:1px solid lightgray" class="detailT4">
					...
					<thead>
						<tr>
							<th colspan="3" style="height: 20px;">성능 점검 SQL</th>
