...
<html lang="ko">
<head>
	<title>성능 점검 1차 메뉴 > SQL 성능 추적 현황 2차 메뉴 > 성능 점검 SQL 3차 메뉴 > SQL 성능 추적 현황 탭 > 성능 점검 SQL 탭</title>
	<meta charset="utf-8" />
	...
	<script type="text/javascript" src="/resources/js/ui/performanceCheckSqlDesign/sqlPerformanceTraceStatus/performanceCheckSql.js?ver=<%=today%>"></script>
</head>
