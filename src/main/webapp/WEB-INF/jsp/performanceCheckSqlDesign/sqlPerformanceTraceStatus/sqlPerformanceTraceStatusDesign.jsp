...
<html lang="ko">
<head>
	<title>SQL 성능 추적 현황 탭 Design</title>
	<meta charset="utf-8" />
	...
	<script type="text/javascript" src="/resources/js/ui/performanceCheckSqlDesign/sqlPerformanceTraceStatus/sqlPerformanceTraceStatusDesign.js?ver=<%=today%>"></script>
	<style>
		.tabs-header{
	...
	<div id="contents">
		<div class="easyui-panel" data-options="border:false" style="width:100%;min-height:730px">
			<div id="sqlPerformanceTraceStatusTab" class="easyui-tabs" data-options="fit:true,border:false">
				<div title="성능 점검 SQL" data-options="fit:true,tabWidth:100" style="padding:5px;">
					<iframe id="sqlPerformanceTraceStatusDesignIF1" name="sqlPerformanceTraceStatusDesignIF1" frameborder="0" framespacing="0" marginheight="0" marginwidth="0" scrolling="no" vspace="0" 
							src="/PerformanceCheckSql" style="width:100%;min-height:680px;"></iframe>
				</div>
