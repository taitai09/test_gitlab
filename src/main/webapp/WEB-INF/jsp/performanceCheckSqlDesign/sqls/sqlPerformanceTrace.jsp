...
<html lang="ko">
<head>
	<title>성능 점검 1차 메뉴 > SQL 성능 추적 현황 2차 메뉴 > 성능 점검 SQL 3차 메뉴 > SQLs 탭 > SQL 성능 추적</title>
	<meta charset="utf-8" />
	...
	<script type="text/javascript" src="/resources/js/ui/performanceCheckSqlDesign/sqls/sqlPerformanceTrace.js?ver=<%=today%>"></script>
</head>
	...
	<div id="contents">
		<form:form method="post" id="submit_form" name="submit_form" class="form-inline">
			...
			<div class="easyui-layout" data-options="border:false" style="width:100%;height:275px;">
				<div id="sql_performance_trace" class="sql_performance_trace .font-15">
					<div class="sql_performance_trace_table">
						<div class="sql_performance_trace_step">
							<span id="sql_performance_trace_name_begin" class="sql_performance_trace_name_begin">이전 운영 성능</span>
						...
						<div class="sql_performance_trace_step">
							<span id="sql_performance_trace_name_current" class="sql_performance_trace_name_begin">검증 성능</span>
							<span id="sql_performance_trace_point_current" class="sql_performance_trace_point_current"></span>
						</div>
						
						<div class="sql_performance_trace_space">
							<div id="sql_performance_trace_space_line_current" class="sql_performance_trace_space_line_default"></div>
						</div>
						
						<div class="sql_performance_trace_step">
							<span id="sql_performance_trance_name_after" class="sql_performance_trace_name_begin">배포후 운영 성능</span>
				...
				<div id="sql_performance_trace" class="sql_performance_trace .font-15">
					<div class="sql_performance_trace_table">
						<div id="sql_performance_trace_status_begin" class="sql_performance_trace_status">
...
<!-- 							<ul class="sql_performance_trace_status_ul_colon"> -->
						...
						<div class="sql_performance_trace_status_value">
							<ul class="sql_performance_trace_status_ul_value">
								<li id="sql_performance_trace_status_li_value_before_elapsed_time" class="sql_performance_trace_status_li_value"></li>
								<li id="sql_performance_trace_status_li_value_before_buffer_gets" class="sql_performance_trace_status_li_value"></li>
								<li id="sql_performance_trace_status_li_value_before_rows_processed" class="sql_performance_trace_status_li_value"></li>
								<li id="sql_performance_trace_status_li_value_before_sql_id" class="sql_performance_trace_status_li_value_action" onclick="sqlPerformanceDetailBegin(this.id)"></li>
								<li id="sql_performance_trace_status_li_value_before_plan_hash_value" class="sql_performance_trace_status_li_value"></li>
								<li id="sql_performance_trace_status_li_value_before_last_active_time" class="sql_performance_trace_status_li_value"></li>
							</ul>
						</div>
						...
						<div id="sql_performance_trace_status_current" class="sql_performance_trace_status">
							<ul class="sql_performance_trace_status_ul">
								...
								<li class="sql_performance_trace_status_li">SQL ID</li>
								<li class="sql_performance_trace_status_li">PLAN HASH VALUE</li>
								<li class="sql_performance_trace_status_li">성능점검일자</li>
