...
<head>
	...
	<script type="text/javascript" src="/resources/js/ui/performanceCheckSqlDesign/sqls/sqls.js?ver=<%=today%>"></script>
				...
				<div class="well">
					...
					<div class="multi">
						<span style="margin-right: 20px;">
							<label>검색조건</label>
							<select id="selectSearchType" name="selectSearchType" data-options="panelHeight:'auto',editable:false" class="w120 easyui-combobox">
								<option value="00">전체</option>
								<option value="01">성능 점검 SQL</option>
				...
				<div id="bottomSqlsTab" class="easyui-tabs" data-options="fit:true,border:false,plain:true">
					...
					<div title="SQL Info<i class='fas fa-expand-arrows-alt' id='btn_sqlInfo_pop'></i>" data-options="fit:true" style="padding-top:5px;border-bottom:1px solid;">
						<iframe id="bottomSqlsTabDesignIF2" name="bottomSqlsTabDesignIF2" frameborder="0" framespacing="0" marginheight="0" marginwidth="0" scrolling="no" vspace="0" 
								style="width: 100%;min-height: 630px;"></iframe>
					</div>
					<div title="성능 점검 결과" data-options="fit:true" style="padding-top:5px;border-bottom:1px solid";">
...
<!-- container END -->
<div id="sqlInfoPop" class="easyui-window popWin" style="background-color:#ffffff;width:1670px;height:650px;">
	<div class="easyui-layout" data-options="fit:true" style="width:100%;height: 650px;">
		...
		<div class="easyui-layout" data-options="border:false" style="width:100%;height:100%">
			<div data-options="region:'center',split:false,border:false" style="width:100%;height:100%;">
				<div id="pop_tabs" class="easyui-tabs" data-options="fit:true,border:false" style="width:100%;height:100%;">
					<div title="SQL TEXT" class="tabGrid easyui-layout" style="width:100%;padding:10px;height:100%;overflow:auto;">
							<table class="sqlInfoTable">
								<tr>
									<th><i class="fas fa-caret-square-right"></i>성능 점검 SQL</th>
									<th><i class="fas fa-caret-square-right"></i>운영 SQL</th>
								</tr>
								<tr>
									<td>
										<textarea id="sql_text_performance_check" readonly style="height: 320px;"></textarea>
									</td>
									<td>
										<textarea id="sql_text_operation" readonly style="height: 320px;"></textarea>
									</td>
								</tr>
								<tr>
									<td>
										<textarea id="sql_bind_performance_check" readonly style="height: 120px;"></textarea>
									</td>
									<td>
										<textarea id="sql_bind_operation" readonly style="height: 120px;"></textarea>
									</td>
								</tr>
							</table>
					</div>
					
					<div title="PLAN 비교" class="tabGrid" style="padding:5px;">
						<div class="easyui-layout" data-options="fit:true">
							<div data-options="region:'west',split:false" class="scrollLeft" style="width:49.9%;min-height: 400px;">
							...
							<div data-options="region:'east',split:false" class="scrollRight" style="width:49.9%;min-height: 400px;">
								<div class="easyui-panel" data-options="border:false" style="width:100%;height:100%;">
