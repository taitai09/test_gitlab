...
<html lang="ko">
<head>
	<title>신규 배포SQL 성능변화 분석(자동검증) 예외 처리 SQL 탭</title>
	<meta charset="utf-8" />
	...
	<script type="text/javascript" src="/resources/js/ui/performanceCheckSqlDesign/sqlPerformanceTrackingStatus/exceptionHandlingRunSql.js?ver=<%=today%>"></script>
	<style type="text/css">
