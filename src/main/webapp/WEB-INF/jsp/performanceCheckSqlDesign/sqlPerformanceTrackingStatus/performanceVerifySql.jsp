...
<html lang="ko">
<head>
	<title>실행SQL성능변화추적 > 성능검증SQL </title>
	<meta charset="utf-8" />
	...
	<script type="text/javascript" src="/resources/js/ui/performanceCheckSqlDesign/sqlPerformanceTrackingStatus/performanceVerifySql.js?ver=<%=today%>"></script>
	<style type="text/css">
	.treeList [field=deploy_sql_cnt],.treeList [field=wrkjob_cd_nm] {
		cursor: default;
	}
	</style>
</head>
	...
	<form:form method="post" id="submit_form" name="submit_form" class="form-inline">
		...
		<div id="contents">
			<div class="easyui-panel searchAreaSingle" data-options="border:false" style="width:100%">
				<div class="well">
					<label>업무</label>
					<select id="wrkjob_cd_top_level" name="wrkjob_cd_top_level" data-options="panelHeight:'300px',editable:true,required:true" class="w200 easyui-combotree" required="required"></select>
...
<!-- 						<a href="javascript:;" class="w80 easyui-linkbutton" onClick="Test();"><i class="btnIcon fas fa-file-excel fa-lg fa-fw"></i> Test</a> -->
			...
			<div class="easyui-layout treeList" data-options="border:false" style="width:100%;min-height:560px">
				<div data-options="region:'center',split:false,collapsible:false,border:false" style="width:100%;height:510px;padding:1px;">
