...
<head>
	...
	<script type="text/javascript" src="/resources/js/ui/dbChangePerformanceImpactAnalysisForTibero/performanceCompareForTibero.js?ver=<%=today%>"></script>
