...
<html lang="ko">
<head>
	<title>성능검증 :: DB간 SQL성능비교ForTibero :: 성능비교 결과</title>
	<meta charset="utf-8" />
...
<%-- 	<script type="text/javascript" src="/resources/js/ui/include/popup/project_popup.js?ver=<%=today%>"></script> --%>
	...
	<script type="text/javascript" src="/resources/js/ui/dbChangePerformanceImpactAnalysisForTibero/performanceCompareResultForTibero.js?ver=<%=today%>"></script>
				...
				<div class="well">
					<table style="width: 100%">
						...
						<tr height="80px;">
								...
								<table style="width:100%;">
									...
									<tbody>
										<tr height="30px;">
											...
											<td colspan="" align="right"><label>FULL SCAN</label></td>
											<td align="center">
												<input id="fullScan_yn" name="fullScan_yn" class="easyui-checkbox">
											</td>
											<td align="right"><label>PARTITION ALL ACCESS</label></td>
											<td align="center">
												<input id="partition_yn" name="partition_yn" class="easyui-checkbox">
											</td>
										</tr>
										<tr height="30px;">
											<td colspan="4" align="right"><label>오류</label></td>
											<td align="center">
							...
							<td></td>
							<td colspan="4" class="well" style="padding:5px 12px;border:1px solid #eaeaea;">
