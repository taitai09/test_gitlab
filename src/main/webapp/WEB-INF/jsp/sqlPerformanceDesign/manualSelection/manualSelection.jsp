...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/sqlPerformanceDesign/manualSelection/manualSelection.js?ver=<%=today%>"></script>
	...
	<script type="text/javascript" src="/resources/js/ui/include/popup/filter_sql_popup.js?ver=<%=today%>"></script> <!-- FILTER SQL 팝업 -->
...
<div id="container">	
	...
	<div id="contents">
		<form:form method="post" id="submit_form" name="submit_form" class="form-inline">
			<div class="easyui-panel searchAreaMulti3" data-options="border:false" style="width:100%">
<!-- 				<div class="title"> -->
...
<%-- 					<input type="hidden" id="topn_cnt" name="topn_cnt" value="${odsHistSqlstat.topn_cnt}"/> --%>
					...
					<div class="multi">
						...
						<select id="selectOrdered" name="selectOrdered" value="${odsHistSqlstat.selectOrdered}" data-options="panelHeight:'auto',editable:false" required="true" class="w120 easyui-combobox">
							<option value="" <c:if test="${odsHistSqlstat.selectOrdered eq ''}">selected</c:if>></option>
						...
						<span style="margin-left:10px;">
							<a href="javascript:;" class="w80 easyui-linkbutton" onClick="showFilterSQL();"><i class="btnIcon fas fa-plus-circle fa-lg fa-fw"></i> Filter SQL</a>
						</span>
						<input type="text" id="extra_filter_predication" name="extra_filter_predication" class="w200 easyui-textbox" readonly="true"/>
					</div>
					<div class="multi">
			...
			<div class="easyui-panel" data-options="border:false" style="width:100%;min-height:490px">
				<!-- type 1 -->
...
<%@include file="/WEB-INF/jsp/include/popup/filter_sql_popup.jsp" %> <!-- FILTER SQL 팝업 -->
</body>
</html>