...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/sqlPerformanceDesign/manualSelection/manualSelectionStatus.js?ver=<%=today%>"></script>
...
<div id="container">	
	<!-- contents START -->
	<div id="contents">
		<div class="easyui-panel searchAreaSingle2" data-options="border:false" style="width:100%">
<!-- 			<div class="title"> -->
...
<!-- 			</div> -->
			<div class="well">
				<form:form method="post" id="submit_form" name="submit_form" class="form-inline">
					...
					<label>프로젝트</label>
					<select id="project_id" name="project_id" data-options="editable:false"  class="w150 easyui-combobox"></select>
		...
		<div class="easyui-panel" data-options="border:false" style="width:100%;min-height:290px">
			<table id="tableList" class="tbl easyui-datagrid" data-options="fit:true,border:false">
			</table>
		</div>
		<div class="easyui-panel" data-options="border:false" style="padding-top:5px; wodth:100%; min-height:270px">
