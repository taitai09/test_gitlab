...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/sqlPerformanceDesign/autoSelection/autoSelectionStatus.js?ver=<%=today%>"></script>
...
<div id="container">	
	...
	<div id="contents">
		...
		<div class="searchBtn innerBtn2" style="margin-top:10px;">
			<a href="javascript:;" class="w100 easyui-linkbutton" onClick="endBatchTuning();"><i class="btnIcon fas fa-stop-circle fa-lg fa-fw"></i> 일괄 튜닝 종료</a>
		</div>
	</div>
	<!-- contents END -->
</div>
<!-- container END -->
<%@include file="/WEB-INF/jsp/include/popup/batchTuning_popup.jsp" %> <!-- 성능개선 - 성능개선관리 상세 관련 팝업 -->
</body>
</html>