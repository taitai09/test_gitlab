...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/basicInformation/dbInfo.js?ver=<%=today%>"></script>
</head>
		...
		<div class="easyui-panel searchArea" data-options="border:false" style="width:100%;">
			...
			<div class="well">
				<form:form method="post" id="submit_form" name="submit_form" class="form-inline">
					...
					<input type="hidden" id="dbid" name="dbid" value="${spopPreferences.dbid}"/>
					<input type="hidden" id="pref_grp" name="pref_grp" value="${spopPreferences.pref_grp}"/>
					<input type="hidden" id="pref_mgmt_type_cd" name="pref_mgmt_type_cd" value="2"/>
					
					<input type="hidden" id="menu_nm" name="menu_nm" value="${menu_nm}"/>
					
					<label>DB</label>
					<select id="selectCombo" name="selectCombo" data-options="editable:false" class="w150 easyui-combobox" required="required"></select>
												...
												<tr>
													...
													<td>														
														...
														<c:choose>
															...
															<c:when test="${basic.pref_id eq '14017'}">
