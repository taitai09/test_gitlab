...
<html lang="ko">
<head>
	<title>SQL 표준 점검 예외 대상 관리</title>
	<meta charset="utf-8">
	...
	<script type="text/javascript" src="/resources/js/ui/sqlStandardDesign/operation/maintainQualityCheckException.js?ver=<%=today%>"></script>
...
<div id="container">
	<div id="contents">
		<form:form method="post" id="submit_form" name="submit_form" class="form-inline">
			<div class="easyui-panel" data-options="border:false" style="width:100%;margin-bottom: 15px;">
				<div class="well">
			...
			<div class="easyui-panel" data-options="border:false" style="width:100%;min-height:300px;margin-bottom:5px;">
		...
		<div class="easyui-panel" data-options="border:false" style="width:100%;min-height:270px">
			<form:form method="post" id="detail_form" name="detail_form" class="form-inline">
				...
				<table class="detailT">
					...
					<tr>
						<th>품질 점검 지표 코드</th>
						<td>
							<select id="bottom_qty_chk_idt_cd" name="bottom_qty_chk_idt_cd" data-options="panelHeight:'300px',editable:true" required="true" class="w200 easyui-combobox"></select>
