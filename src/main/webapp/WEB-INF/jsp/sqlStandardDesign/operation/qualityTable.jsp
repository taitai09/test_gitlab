...
<div id="container">
	...
	<form:form method="post" id="submit_form" name="submit_form" class="form-inline">
		...
		<div id="contents">
			...
			<div class="easyui-layout" data-options="border:false" style="width:100%;min-height:610px">
				<div data-options="region:'center',split:false,collapsible:false,border:false" style="width:100%;height:100%;padding:10px 0px;">
