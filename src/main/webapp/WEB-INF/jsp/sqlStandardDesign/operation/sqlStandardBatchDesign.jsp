...
<head>
	...
	<script type="text/javascript" src="/resources/js/ui/sqlStandardDesign/operation/sqlStandardOperationDesign.js?ver=<%=today%>"></script>
	<script type="text/javascript">
		var auth_cd = '${auth_cd}';
		var leader_yn = '${leader_yn}';
		var wrkjob_cd = '${wrkjob_cd}';
	</script>
	<style>
		.tabs-header{
	...
	<div id="contents">
		...
		<div class="easyui-panel" data-options="border:false" style="width:100%;min-height:730px">
			<div id="operationDesignTab" class="easyui-tabs" data-options="fit:true,border:false">
				...
				<div title="표준 미준수 SQL" data-options="fit:true" id="hideTarget" style="padding:5px;min-height:680px;">
