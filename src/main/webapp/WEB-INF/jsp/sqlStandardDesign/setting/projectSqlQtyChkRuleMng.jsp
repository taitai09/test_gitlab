			...
			<form:form method="post" id="detail_form" name="detail_form" class="form-inline">
				...
				<table class="detailT">
					...
					<tr>
						<th>적용여부</th>
						<td>
							<select id="apply_yn" name="apply_yn" data-options="panelHeight:'auto',editable:false" required="true" class="w80 easyui-combobox">
...
<!-- 							<input type="text" id="qty_chk_idt_cd" name="qty_chk_idt_cd" class="w220 easyui-textbox"/> -->
					...
					<tr>
						...
						<td colspan="9" style="vertical-align:top;">
							<textarea name="qty_chk_sql" id="qty_chk_sql" rows="10" cols="350" required style="overlow:scroll;margin-top:3px;padding:5px;width:98%;height:140px;" wrap="off" placeholder="품질 점검 RULE을 입력하세요." class="validatebox-invalid"></textarea>
						</td>
					</tr>
				</table>
