...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/sqlDiagnostics/planChangeSQL.js?ver=<%=today%>"></script>
	...
	<div id="contents">
		<div class="easyui-panel searchArea" data-options="border:false" style="width:100%">
			...
			<div class="well">
				<form:form method="post" id="submit_form" name="submit_form" class="form-inline">
					...
					<input type="hidden" id="dbid" name="dbid" value="${planChangeSql.dbid}"/>
					...
					<input type="hidden" id="after_plan_hash_value" name="after_plan_hash_value"/>
					<input type="hidden" id="plan_hash_value" name="plan_hash_value"/>
					<input type="hidden" id="choice_id" name="choice_id" value="5"/> <!-- PLAN_CHANGE_SQL -->	
					<input type="hidden" id="tableName" name="tableName" value="PLAN_CHANGE_SQL"/>
					...
					<label>기준일</label>
					<input type="text" id="strStartDt" name="strStartDt" value="${planChangeSql.strStartDt}" data-options="panelHeight:'auto',editable:false" required="true" class="w130 datapicker easyui-datebox"/> ~
					<input type="text" id="strEndDt" name="strEndDt" value="${planChangeSql.strEndDt}" data-options="panelHeight:'auto',editable:false" required="true" class="w130 datapicker easyui-datebox"/>
		...
		<div class="easyui-panel" data-options="border:false" style="width:100%;min-height:650px">
			<div id="sqlTabs" class="easyui-tabs" data-options="plain:true,fit:true,border:false">
				<div title="PLAN CHANGE SQL" style="padding:5px;">				
					<div class="searchBtn innerBtn">
						...
						<a href="javascript:;" class="w80 easyui-linkbutton" onClick="showTuningReqPopup();"><i class="btnIcon fas fa-edit fa-lg fa-fw"></i> 튜닝요청</a>
					</div>
