...
<!-- 	<script type="text/javascript" src="/resources/js/ui/include/popup/project_popup_paging.js"></script> -->
	<script type="text/javascript" src="/resources/js/ui/solutionProgramMng/dataCollectionStatus.js?ver=<%=today%>"></script>
...
<div id="container">
	...
	<form:form method="post" id="submit_form" name="submit_form" class="form-inline">
		...
		<input type="hidden" id="slt_program_sql_number" name="slt_program_sql_number" value="10233"/>
		<input type="hidden" id="hard_work_type" name="hard_work_type"/>
		<input type="hidden" id="base_day" name="base_day"/>
		
		<!-- 이전, 다음 처리 -->
<%-- 		<input type="hidden" id="currentPage" name="currentPage" value="${solutionProgramMng.currentPage}"/> --%>
<!-- 		<input type="hidden" id="pagePerCount" name="pagePerCount" value="${solutionProgramMng.pagePerCount}"/> -->
		...
		<div id="contents">
			<div class="easyui-panel searchArea" data-options="border:false" style="width:100%">
				...
				<div class="well">
					<label>DB</label>
					<select id="dbid" name="dbid" data-options="panelHeight:'auto',editable:false" class="w130 easyui-combobox"></select>
					<label>수집일자</label>
					<input type="text" id="nowDate" name="nowDate" value="${nowDate}" data-options="panelHeight:'auto',editable:false" class="w130 datapicker easyui-datebox"/>
