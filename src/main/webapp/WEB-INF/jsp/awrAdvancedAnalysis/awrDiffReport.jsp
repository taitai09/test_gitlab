...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/awrAdvancedAnalysis/awrDiffReport.js?ver=<%=today%>"></script>
		...
		<div class="easyui-panel searchAreaMulti" data-options="border:false" style="width:100%;">
			...
			<div class="well">
				<form:form method="post" id="submit_form" name="submit_form" class="form-inline">
					...
					<div class="multi">
						<label>Diff 1 ▶ SNAP ID</label>
						<input type="text" id="start_snap_id1" name="start_snap_id1" data-options="readonly:'true'" class="w80 easyui-textbox" required="true"/> ~
						<input type="text" id="end_snap_id1" name="end_snap_id1" data-options="readonly:'true'" class="w80 easyui-textbox" required="true"/>
						&nbsp;&nbsp;<a href="javascript:;" class="easyui-linkbutton" onClick="fnShowSnapPopup('report1');"><i class="btnIcon fas fa-search fa-lg fa-fw"></i></a>
						&nbsp;&nbsp;<a href="javascript:;" class="w120 easyui-linkbutton" onClick="showBaseLinePopup('1');"><i class="btnIcon fas fa-check fa-lg fa-fw"></i> 베이스라인 선택</a>
						<label>Diff 2 ▶ SNAP ID</label>
						<input type="text" id="start_snap_id2" name="start_snap_id2" data-options="readonly:'true'" class="w80 easyui-textbox" required="true"/> ~
						<input type="text" id="end_snap_id2" name="end_snap_id2" data-options="readonly:'true'" class="w80 easyui-textbox" required="true"/>
						&nbsp;&nbsp;<a href="javascript:;" class="easyui-linkbutton" onClick="fnShowSnapPopup('report2');"><i class="btnIcon fas fa-search fa-lg fa-fw"></i></a>
						&nbsp;&nbsp;<a href="javascript:;" class="w120 easyui-linkbutton" onClick="showBaseLinePopup('2');"><i class="btnIcon fas fa-check fa-lg fa-fw"></i> 베이스라인 선택</a>								
...
<!-- 					</div>							 -->
		...
		<div class="easyui-panel" data-options="border:false" style="width:100%;margin-bottom:10px;">
			<div style="float:right;">
				...
				<a href="javascript:;" class="w80 easyui-linkbutton" onClick="Btn_PrintClick();"><i class="btnIcon fas fa-save fa-lg fa-fw"></i> 프린트</a>
			</div>
		</div>
		<div id="dataArea" class="easyui-panel" data-options="border:true" style="width:100%;padding:10px;height:630px;font-family:'굴림체';">
		</div>
	</div>
	<!-- contents END -->
</div>
