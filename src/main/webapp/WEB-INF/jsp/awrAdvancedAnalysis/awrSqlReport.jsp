...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/awrAdvancedAnalysis/awrSqlReport.js?ver=<%=today%>"></script>
		...
		<div class="easyui-panel searchAreaMulti" data-options="border:false" style="width:100%;">
			...
			<div class="well">
				<form:form method="post" id="submit_form" name="submit_form" class="form-inline">
					...
					<div class="multi">
						<label>SQL ID</label>
						<input type="text" id="sql_id" name="sql_id" class="w150 easyui-textbox" required="true"/>
