...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/systemManage/projectMng.js?ver=<%=today%>"></script>
</head>
			...
			<form:form method="post" id="detail_form" name="detail_form" class="form-inline">
				...
				<table class="detailT">
					...
					<tr>
						<th >프로젝트설명</th>
							<td colspan="5">
							<input id="project_desc" name="project_desc" rows="30" data-options="multiline:true" class="easyui-textbox" style="width:100%;height:80px" ></textarea>
						</td>
					</tr>
					<tr>
						<th>등록일시</th>
					...
					<tr>
						<th>종료여부</th>
						<td>
							<select id="del_yn" name="del_yn" data-options="panelHeight:'auto',editable:false" class="w200 easyui-combobox">
