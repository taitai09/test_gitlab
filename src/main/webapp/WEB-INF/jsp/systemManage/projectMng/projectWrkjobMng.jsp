...
<head>
	...
	<script type="text/javascript" src="/resources/js/ui/systemManage/projectMng/projectWrkjobMng.js?ver=<%=today%>"></script>
...
<!-- 						<input type="text" id="project_nm" name="project_nm" value="" class="w250 easyui-textbox"/> -->
			...
			<div class="easyui-layout" data-options="border:false" style="width:100%;min-height:400px">
				<div data-options="region:'center',split:false,collapsible:true,border:false" style="width:100%;height:100%;padding-top:0px;">
					<table id="tableList" class="tbl easyui-datagrid" data-options="fit:true,border:false">
					</table>
				</div>
			</div>
			<div class="searchBtn" data-options="collapsible:false,border:false" style="padding-top:10px;text-align:right;">
...
<!-- 							<input type="text" id="project_nm" name="project_nm"  data-options="required:true" class="w250 easyui-textbox"/> -->
							<select id="project_id" name="project_id" data-options="required:true" class="w250 easyui-combobox" >
							<option value=""></option>
							<c:forEach items="${projectList}" var="list">
								<option value="${list.project_id}"> ${list.project_nm}</option>
							</c:forEach>
