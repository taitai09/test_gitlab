...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/indexDesignPreProcessing/loadSQL.js?ver=<%=today%>"></script>    
	<!-- 성능개선 - 인덱스 설계 전처리 - SQL 적재 팝업 -->
	<script type="text/javascript" src="/resources/js/ui/include/popup/loadSQL_popup.js?ver=<%=today%>"></script> 
