...
<link rel="stylesheet" href="/resources/css/style.css?ver=<%=today%>" />
...
<script type="text/javascript" src="/resources/js/ui/include/popup/licenceCheck_popup.js?ver=<%=today%>"></script>
