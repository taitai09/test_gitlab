...
<div id="batchTuningPop" class="easyui-window popWin" style="background-color:#ffffff;width:440px;height:280px;">
	<div class="easyui-layout" data-options="fit:true">
		<form:form method="post" id="batchTuning_form" name="batchTuning_form" class="form-inline">
			...
			<div class="easyui-layout" data-options="region:'south',split:false,border:false" style="height:50px;">
				<div class="searchBtn" style="padding-right:35px;">
					...
					<a href="javascript:;" class="w80 easyui-linkbutton" onClick="Btn_OnClosePopup('batchTuningPop');"><i class="btnRIcon fas fa-window-close fa-lg fa-fw"></i> 취소</a>
				</div>
			</div>
		</form:form>
	</div>
