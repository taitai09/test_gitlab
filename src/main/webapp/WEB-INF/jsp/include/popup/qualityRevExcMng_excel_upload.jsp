...
<div id="qualityRevExcMng_excel_upload_popup" class="easyui-window popWin" style="background-color:#ffffff;width:420px;height:160px;">
	<div class="easyui-panel" data-options="fit:true" style="padding:20px 30px;">
		<form:form method="post" id="qualityRevExcMng_form" name="qualityRevExcMng_form" enctype="multipart/form-data" class="form-inline">
			...
			<div class="searchBtn" style="margin-top:20px;margin-right:-5px;">
				...
				<a href="javascript:;" class="w80 easyui-linkbutton" onClick="Btn_OnClosePopup('qualityRevExcMng_excel_upload_popup');"><i class="btnRIcon fas fa-window-close fa-lg fa-fw"></i> 닫기</a>
			</div>
		</form:form>
	</div>
</div>
