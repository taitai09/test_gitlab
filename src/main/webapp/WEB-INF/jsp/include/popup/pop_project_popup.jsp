...
<div id="popProjectListPop" class="easyui-window popWin" style="background-color:#ffffff;width:1000px;height:650px;">
	<div class="easyui-layout" style="height:580px;margin:10px;">
		<form:form method="post" id="pop_projectList_form" name="pop_projectList_form" class="form-inline">
			<div data-options="region:'north',border:false" style="width:100%;height:80px;">
				<div class="well">
					...
					<span class="searchBtnLeft">
						<a href="javascript:;" class="w50 easyui-linkbutton" onClick="Btn_SearchProjectListPop();"><i class="btnIcon fas fa-search fa-lg fa-fw"></i> 검색</a>
					</span>
