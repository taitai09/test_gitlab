...
<html lang="ko">
<head>
	<title>애플리케이션 성능 점검 - SQL식별자(DBIO) 상세내역</title>
	<meta charset="utf-8" />
    ...
    <script type="text/javascript" src="/resources/js/ui/preDeploymentCheck/applicationDbioCheck.js?ver=<%=today%>"></script>
</head>
<body>
<!-- container START -->
<div id="container">	
	...
	<div id="contents">
		<div class="easyui-panel searchArea" data-options="border:false" style="width:100%">
			...
			<div class="well">
				<form:form method="post" id="submit_form" name="submit_form" class="form-inline">
					...
					<input type="hidden" id="lst_tr_cd" name="lst_tr_cd" value="${deployPerfCheck.lst_tr_cd}"/>
					...
					<input type="hidden" id="perf_fitness_yn" name="perf_fitness_yn" value="${deployPerfCheck.perf_fitness_yn}"/>
					<label>SQL식별자(DBIO)</label>
					<input type="text" id="dbio" name="dbio" value="${deployPerfCheck.dbio}" class="w200 easyui-textbox"/>
					<label>금지힌트사용</label>
		...
		<div class="searchBtn innerBtn" style="margin-top:10px;margin-bottom:0px;">
			<a href="javascript:;" class="w100 easyui-linkbutton" onClick="goApplicationDetailCheck();"><i class="btnIcon fas fa-list fa-lg fa-fw"></i> 돌아가기</a>
		</div>		
	</div>
	<!-- contents END -->
</div>
