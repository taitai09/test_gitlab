...
<html lang="ko">
<head>
	<title>SQL식별자(DBIO) 성능점검 - 상세내역</title>
	<meta charset="utf-8" />
    ...
    <script type="text/javascript" src="/resources/js/ui/preDeploymentCheck/dbioDetailCheck.js?ver=<%=today%>"></script>
</head>
<body>
<!-- container START -->
<div id="container">
	...
	<div id="contents">
		<div class="easyui-panel searchArea" data-options="border:false" style="width:100%">
			<div class="title">
				<span class="h3">SQL식별자(DBIO) 성능점검 상세내역</span>
			</div>
			<div class="well">
		...
		<div class="searchBtn innerBtn" style="margin-top:10px;margin-bottom:0px;">
			<a href="javascript:;" class="w100 easyui-linkbutton" onClick="returnDBIODetailCheck();"><i class="btnIcon fas fa-list fa-lg fa-fw"></i> 돌아가기</a>
		</div>		
	</div>
	<!-- contents END -->
</div>
