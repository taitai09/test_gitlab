...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/preDeploymentCheck/applicationCheck.js?ver=<%=today%>"></script>
		...
		<div class="easyui-panel searchArea" data-options="border:false" style="width:100%">
			...
			<div class="well">
				<form:form method="post" id="submit_form" name="submit_form" class="form-inline">
					...
					<div class="searchBtn">
						<a href="javascript:;" class="w110 easyui-linkbutton" onClick="Btn_ExcelUploadPopup('1');"><i class="btnIcon fas fa-upload fa-lg fa-fw"></i> 성능점검등록</a>								
					</div>
				</form:form>
			</div>
		</div>
