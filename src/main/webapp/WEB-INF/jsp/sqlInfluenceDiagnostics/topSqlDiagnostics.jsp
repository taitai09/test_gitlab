...
<html lang="ko">
<head>
	<title>성능진단 :: 변경 영향도 진단 :: DB변경 SQL영향도 진단</title>
	<meta charset="utf-8" />
    ...
    <script type="text/javascript" src="/resources/js/ui/sqlInfluenceDiagnostics/topSqlDiagnostics.js?ver=<%=today%>"></script>
		...
		<div class="easyui-panel searchArea" data-options="border:false" style="width:100%">
			...
			<div class="well">
				<form:form method="post" id="submit_form" name="submit_form" class="form-inline">
					...
					<input type="hidden" id="dbid" name="dbid" value="${beforePerfExpect.dbid}"/>
