...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/indexDesignMaintenance/collectionIndexDesign.js?ver=<%=today%>"></script>
			...
			<div title="테이블 목록" style="padding:10px;">
				<div class="easyui-layout" data-options="fit:true,border:false">
					<div data-options="region:'west',split:false,collapsible:false,border:false" style="padding-left:5px;padding-right:5px;width:98%;height:100%">
						<table id="odstableList" class="tbl easyui-datagrid" data-options="fit:true,border:false" style="height:600px">
							<tbody><tr></tr></tbody>
						</table>
					</div>
