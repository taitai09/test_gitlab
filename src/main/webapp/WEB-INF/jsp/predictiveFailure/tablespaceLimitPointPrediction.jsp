...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/predictiveFailure/tablespaceLimitPointPrediction.js?ver=<%=today%>"></script>
    <script>
    	loginUserId = "${loginId}";
    </script>   
</head>
...
<!-- 					<font size="5">화면준비중입니다.</font> -->
					<label>예측 기준</label>
					<select id="selectValue" name="selectValue" data-options="panelHeight:'auto',editable:false" class="w200 easyui-combobox" required="required">
			...
			<div class="easyui-layout" data-options="border:false" style="width:100%;height:90%;">
				<div class="easyui-panel" data-options="border:true" style="width:100%;height:630px">
