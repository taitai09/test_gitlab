...
<html lang="ko">
<head>
	<title>성능 점검 :: 성능 점검 단계 관리 :: 업무별 성능 점검 단계 관리</title>
	<meta charset="utf-8" />
    ...
    <script type="text/javascript" src="/resources/js/ui/performanceCheckIndex/deployPerfChkStepTestDB.js?ver=<%=today%>"></script>
</head>
		...
		<div class="easyui-panel searchArea" data-options="border:false" style="width:100%;">
			...
			<div class="well">
				<form:form method="post" id="submit_form" name="submit_form" class="form-inline">
					...
					<label>업무</label>
					<select id="search_wrkjob_cd" name="search_wrkjob_cd" data-options="panelHeight:'200px',editable:false" class="w150 easyui-combotree"></select>
			...
			<form:form method="post" id="detail_form" name="detail_form" class="form-inline">
				...
				<table class="detailT">
					...
					<tr>
						<th>업무</th>
							<td>
								<select id="wrkjob_cd" name="wrkjob_cd" data-options="panelHeight:'auto',editable:false" class="w150 easyui-combobox">
								</select>	
							</td>
						<th>점검 단계</th>
							<td>
					...
					<tr>
						...
						<th>프로그램</th>
							<td>
								<select id="program_div_cd" name="program_div_cd" data-options="panelHeight:'auto',editable:false" class="w150 easyui-combobox">
								</select>	
							</td>
<!-- 						<th>스키마</th> -->
<!-- 							<td> -->
