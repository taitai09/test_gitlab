...
<html lang="ko">
<head>
	<title>성능 점검 :: 성능 점검 단계 관리 :: 성능 점검 현황</title>
	<meta charset="utf-8" />
    ...
    <script type="text/javascript" src="/resources/js/ui/performanceCheckIndex/perfCheckState.js?ver=<%=today%>"></script>
...
<div id="container">	
	...
	<div id="contents">
		...
		<div id="perf_exec_req_tab" class="easyui-tabs" data-options="border:false" style="width:100%;height:700px;">
		<div title="CM 점검 현황">
				<div class="easyui-panel searchArea" data-options="border:false" style="width:100%;">
					<div class="title">
						<span id="sub_title" class="h3">▶ CM 점검 현황</span>
					</div>					
					<div class="well">
				...
				<div class="easyui-panel" data-options="border:false" style="width:100%;padding-left:5px;min-height:500px;margin-bottom:10px;">
					<table id="tableList0" class="tbl easyui-datagrid" data-options="fit:true,border:false">
					</table>
				</div>
			</div>
		<div title="프로그램 점검 현황">
				<div class="easyui-panel searchArea" data-options="border:false" style="width:100%;">
					<div class="title">
						<span id="sub_title" class="h3">▶ 프로그램 점검 현황</span>
					</div>					
					<div class="well">
