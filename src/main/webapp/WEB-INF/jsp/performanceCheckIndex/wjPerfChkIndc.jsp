...
<html lang="ko">
<head>
	<title>성능 점검 :: 성능 점검 지표 관리 :: 업무별 성능 점검 지표 관리</title>
	<meta charset="utf-8" />
    ...
    <script type="text/javascript" src="/resources/js/ui/performanceCheckIndex/wjPerfChkIndc.js?ver=<%=today%>"></script>
</head>
...
<!-- 				<input type="hidden" id="perf_check_meth_cd" name="perf_check_meth_cd" /> -->
				...
				<table class="detailT">
					...
					<tr>
						<th>업무</th>
						<td>
							<select id="temp_wrkjob_cd" name="wrkjob_cd" data-options="panelHeight:'200px',editable:true" class="w150 easyui-combotree" readonly="true"></select>
						</td>
						<th>점검 지표</th>
						<td>
							<select id="perf_check_indc_id" name="perf_check_indc_id" data-options="panelHeight:'auto',editable:false" class="w150 easyui-combotree" readonly="true"></select>
						</td>
						<th>프로그램</th>
						<td>
							<select id="perf_check_program_div_cd" name="perf_check_program_div_cd" data-options="panelHeight:'auto',editable:false" class="w150 easyui-combotree"></select>
						</td>
					...
					<tr>
						<th>점검 방법</th>
						<td>
								<select id="perf_check_meth_cd" name="perf_check_meth_cd" data-options="panelHeight:'auto',editable:false" class="w150 easyui-combotree" readonly="true"></select>
						</td>
						<th>적합</th>
							<td>
								<input type="number" id="pass_max_value" name="pass_max_value" class="w150 easyui-textbox"/>
							</td>
						<th>부적합</th>
							<td>
					...
					<tr>
						<th>여부값 판정구분</th>
							<td>
								<select id="yn_decide_div_cd" name="yn_decide_div_cd" data-options="panelHeight:'auto',editable:false" class="w150 easyui-combobox"></select>
							</td>
						<th>지표적용여부</th>
							<td>
								<select id="indc_apply_yn" name="indc_apply_yn" data-options="panelHeight:'auto',editable:false" class="w150 easyui-combobox">
						...
						<tr>
							<th>지표 설명</th>
								<td colspan="5"><textarea id="perf_check_indc_desc" name="perf_check_indc_desc" style="width:100%;height:70px" readonly="true"></textarea></td>
						</tr>
						<tr>
							<th>부적합 가이드</th>
								<td colspan="5"><textarea id="perf_check_fail_guide_sbst" name="perf_check_fail_guide_sbst" style="width:100%;height:70px" readonly="true"></textarea></td>
						</tr>
				</table>
