...
<html lang="ko">
<head>
	<title>성능 점검 :: 성능 점검 단계 관리 :: 성능 점검 예외 처리 현황</title>
	<meta charset="utf-8" />
    ...
    <script type="text/javascript" src="/resources/js/ui/performanceCheckIndex/perfChkIndcListState.js?ver=<%=today%>"></script>
