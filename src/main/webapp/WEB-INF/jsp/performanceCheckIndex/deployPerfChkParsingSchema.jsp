...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/performanceCheckIndex/deployPerfChkParsingSchema.js?ver=<%=today%>"></script>
</head>
		...
		<div class="easyui-panel searchArea" data-options="border:false" style="width:100%;">
			...
			<div class="well">
				<form:form method="post" id="submit_form" name="submit_form" class="form-inline">
					...
					<label>업무</label>
					<select id="search_wrkjob_cd" name="search_wrkjob_cd" data-options="panelHeight:'200px',editable:true" class="w150 easyui-combotree"></select>
