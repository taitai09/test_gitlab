	...
	<form:form method="post" id="submit_form" name="submit_form" class="form-inline">
		...
		<div id="dash_contents">
				<div class="easyui-layout" data-options="border:false" style="width:100%;height:100%;min-height:650px">
					<div data-options="title:'긴급조치대상현황',region:'center',split:false,collapsible:false,border:false" style="width:50%;height:100%;padding:5px;cursor:default;">
						<div class="easyui-panel" data-options="border:false" style="width:100%;height:100%">
							<div id="urgentActionTargetCondChart" title="긴급조치대상현황" style="width:100%;height:100%;padding-top:0px;">
							</div>
						</div>			
					</div>			
				</div>		
