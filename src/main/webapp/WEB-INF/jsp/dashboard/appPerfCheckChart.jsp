...
<head>
	...
	<script type="text/javascript" src="/resources/js/ui/dashboard/appPerfCheckChart.js?ver=<%=today%>"></script>
</head>
<body>
<!-- container START -->
<div id="container">
	...
	<form:form method="post" id="submit_form" name="submit_form" class="form-inline">
		...
		<div id="dash_contents">
				...
				<div class="easyui-layout" data-options="border:false" style="width:100%;min-height:550px;">
					...
					<div data-options="title:'APP성능진단',region:'west',split:false,collapsible:false,border:false" style="width:100%;height:100%;padding:5px;">
						<div class="easyui-panel" data-options="border:false" style="width:100%;height:500px">
							<div id="appPerfCheckChart" title="APP성능진단" style="width:100%;height:100%;padding-top:0px;">
							</div>
						</div>
					</div>
