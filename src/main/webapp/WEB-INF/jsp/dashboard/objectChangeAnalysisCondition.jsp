...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/dashboard/objectChangeAnalysisCondition.js?ver=<%=today%>"></script>
</head>
<body>
<!-- container START -->
<div id="container">
	...
	<div id="contents">
		...
		<div class="easyui-layout" data-options="border:false" style="width:100%;height:100%;min-height:650px">
			<div class="easyui-panel" data-options="border:false" style="width:100%;height:50%">
				<div id="objectChangeAnalysisConditionChart" title="오브젝트변경분석현황" style="width:100%;height:100%;padding-top:0px;">
				</div>
			</div>			
