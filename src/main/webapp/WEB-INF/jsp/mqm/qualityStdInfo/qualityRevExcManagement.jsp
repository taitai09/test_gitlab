...
<html lang="ko">
<head>
	<title> 성능개선 :: 데이터 구조 품질 :: 구조 품질검토 예외 대상 관리</title>
	<meta charset="utf-8" />
    ...
    <script type="text/javascript" src="/resources/js/ui/mqm/qualityStdInfo/qualityRevExcManagement.js?ver=<%=today%>"></script>
			...
			<form:form method="post" id="detail_form" name="detail_form" class="form-inline">
				...
				<table class="detailT">
					...
					<tr>
						<th>비    고</th>
						<td colspan="5">
							<input id="remark" name="remark" rows="30" data-options="multiline:true" class="easyui-textbox" style="width:100%;height:80px" ></textarea>
						</td>
					</tr>
				</table>
