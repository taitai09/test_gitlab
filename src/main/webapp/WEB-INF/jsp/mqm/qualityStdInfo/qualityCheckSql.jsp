...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/mqm/qualityStdInfo/qualityCheckSql.js?ver=<%=today%>"></script>    
</head>
				...
				<table class="detailT">
					...
					<tr>
						...
						<td colspan="3" style="vertical-align:top;">
							<textarea name="qty_chk_sql" id="qty_chk_sql" rows="10" cols="350" style="overlow:scroll;margin-top:3px;padding:5px;width:98%;height:200px" wrap="off"></textarea>
						</td>
					</tr>
				</table>
