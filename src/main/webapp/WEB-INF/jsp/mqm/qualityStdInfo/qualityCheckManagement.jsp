...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/mqm/qualityStdInfo/qualityCheckManagement.js?ver=<%=today%>"></script>
</head>
		...
		<div class="easyui-panel" data-options="border:false" style="width:100%;min-height:320px">
			<form:form method="post" id="detail_form" name="detail_form" class="form-inline">
				...
				<table class="detailT">
					...
					<th>품질점검내용</th>
						<td colspan="7">
							<input id="qty_chk_cont" name="qty_chk_cont" rows="30" data-options="multiline:true" required="true" class="easyui-textbox" style="width:100%;height:80px" ></textarea>
						</td>
					</tr>
					<tr>
					<th>해결방안내용</th>
						<td colspan="7">
							<input id="slv_rsl_cont" name="slv_rsl_cont" rows="30" data-options="multiline:true" class="easyui-textbox" style="width:100%;height:80px" ></textarea>
						</td>
					</tr>
					<tr>
					<th>품질점검결과 테이블명</th>
