...
<html lang="ko">
<head>
	<title>성능개선 :: 데이터 구조 품질 :: 구조 품질검토 작업</title>
	<meta charset="utf-8" />
    ...
    <script type="text/javascript" src="/resources/js/ui/mqm/qualityInspectionJob.js?ver=<%=today%>"></script>    
</head>
...
<!-- 					<label>검색 조건</label>
					<select id="searchKey" name="searchKey" data-options="panelHeight:'auto',editable:false" class="w150 easyui-combobox">
						<option value="1">1. 품질 검토 대상 </option>
						<option value="2">2. 품질 검토 결과 </option>
					</select> -->
