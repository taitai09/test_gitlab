...
<html lang="ko">
<head>
	<title>성능 검증 :: 성능 검증 단계 관리 :: 업무별 파싱 스키마 관리</title>
	<meta charset="utf-8" />
	...
	<script type="text/javascript" src="/resources/js/ui/execSqlPerfCheck/setting/deployPerfChkParsingSchema.js?ver=<%=today%>"></script>
</head>
