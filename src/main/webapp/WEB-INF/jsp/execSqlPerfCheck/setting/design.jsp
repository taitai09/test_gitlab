...
<head>
	...
	<script type="text/javascript" src="/resources/js/ui/execSqlPerfCheck/setting/design.js?ver=<%=today%>"></script>
	<style>
		.tabs-header{
	...
	<div id="contents">
		...
		<div class="easyui-panel" data-options="border:false" style="width:100%;min-height:730px">
			<div id="settingDesignTab" class="easyui-tabs" data-options="fit:true,border:false">
				<div title="성능 검증 지표 관리" data-options="fit:true" style="padding-top:5px;">
				...
				<div title="성능 검증 단계 관리" data-options="fit:true" style="padding-top:5px;">
				...
				<div title="업무별 성능 검증 지표 관리" data-options="fit:true" style="padding-top:5px;">
				...
				<div title="업무별 성능 검증 단계 관리" data-options="fit:true" style="padding-top:5px;">
