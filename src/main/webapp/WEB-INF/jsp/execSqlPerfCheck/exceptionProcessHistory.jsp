...
<html lang="ko">
<head>
	<title>성능 검증 :: 실행 SQL 성능 검증 :: 성능 검증 예외 처리 이력</title>
	<meta charset="utf-8" />
    ...
    <script type="text/javascript" src="/resources/js/ui/execSqlPerfCheck/exceptionProcessHistory.js?ver=<%=today%>"></script>
...
<!-- 							<input type="checkbox" class="easyui-checkbox" id="search_chk" name="search_chk" value="search_chk" style="margin-right:5px;" > -->
		...
		<div id="perf_exec_req_tab" class="easyui-tabs" data-options="border:false" style="width:100%;height:340px;border-bottom:1px solid lightgray;">
...
<!-- 								SQL TEXT<br/><br/> -->
			...
			<div title="성능검증결과" style="border:0px;">
