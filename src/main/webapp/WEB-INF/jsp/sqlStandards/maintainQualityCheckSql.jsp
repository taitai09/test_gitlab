		...
		<div class="easyui-panel" data-options="border:false" style="width:100%;min-height:300px">
			<form:form method="post" id="detail_form" name="detail_form" class="form-inline">
				...
				<table class="detailT">
					...
					<tr>
						<th>품질 점검 지표 코드</th>
						<td class="ltext"><select id="ui_qty_chk_idt_cd" name="ui_qty_chk_idt_cd" data-options="panelHeight:'220',editable:false,required:true" class="w200 easyui-combobox"></select></td>
						<th>DML 여부</th>
						<td><select id="dml_yn" name="dml_yn" data-options="panelHeight:'auto',editable:false,required:true" class="w60 easyui-combobox">
						...
						<th>프로젝트 단위 관리 여부</th>
						<td><select id="project_by_mgmt_yn" name="project_by_mgmt_yn" data-options="panelHeight:'auto',editable:false,required:true" class="w60 easyui-combobox">
							<option value="">선택</option>
							<option value="Y">Y</option>
							<option value="N">N</option>
							</select>
					...
					<tr>
						...
						<td colspan="5" style="vertical-align:top;">
							<textarea name="qty_chk_sql" id="qty_chk_sql" rows="10" style="overlow:scroll;margin-top:3px;padding:5px;width:98%;height:200px" wrap="off"></textarea>
						</td>
					</tr>
				</table>
