...
<!-- 							<input type="text" id="qty_chk_idt_cd" name="qty_chk_idt_cd" class="w220 easyui-textbox"/> -->
					...
					<tr>
						<th>품질 점검 내용</th>
						<td colspan="7"><textarea id="qty_chk_cont" name="qty_chk_cont" style="width:100%;height:80px"></textarea></td>
					</tr>
					<tr>
						<th>해결 방안 내용</th>
						<td colspan="7"><textarea id="slv_rsl_cont" name="slv_rsl_cont" style="width:100%;height:80px"></textarea></td>
					</tr>
				</table>
