...
<head>
	...
	<script type="text/javascript" src="/resources/js/ui/sqlStandards/nonCompliantCode.js?ver=<%=today%>"></script>
		...
		<div id="contents">
			...
			<div class="easyui-layout" data-options="border:false" style="width:100%;min-height:620px">
				<div data-options="region:'center',split:false,collapsible:false,border:false" style="width:100%;height:100%;padding:10px;">
					<table id="tableList" class="tbl easyui-datagrid" data-options="fit:true,border:false,fitColumns:true">
					</table>
				</div>
			</div>
