		...
		<div class="easyui-panel" data-options="border:false" style="width:100%;min-height:310px;">
			<form:form method="post" id="detail_form" name="detail_form" class="form-inline">
				...
				<table class="detailT">
					...
					<tr>
						<th>품질 점검 내용</th>
						<td colspan="7"><textarea id="qty_chk_cont" name="qty_chk_cont" style="width:100%;height:80px" placeholder="품질 점검 내용을 입력하세요."></textarea></td>
					</tr>
					<tr>
						<th>해결 방안 내용</th>
						<td colspan="7"><textarea id="slv_rsl_cont" name="slv_rsl_cont" style="width:100%;height:80px" placeholder="해결 방안 내용을 입력하세요."></textarea></td>
					</tr>
				</table>
