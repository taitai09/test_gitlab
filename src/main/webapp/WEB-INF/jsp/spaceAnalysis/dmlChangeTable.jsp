...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/spaceAnalysis/dmlChangeTable.js?ver=<%=today%>"></script>
</head>
		...
		<div class="easyui-panel searchArea" data-options="border:false" style="width:100%">
			...
			<div class="well">
				<form:form method="post" id="submit_form" name="submit_form" class="form-inline">
					...
					<input type="hidden" id="subpartition_name" name="subpartition_name"/>
					<input type="hidden" id="partition_name" name="partition_name"/>

					<label>DB</label>
					<select id="selectCombo" name="selectCombo" data-options="editable:true" class="w130 easyui-combobox" required="true"></select>
					<label>OWNER</label>
					<select id="selectUserName" name="selectUserName" data-options="editable:true" class="w130 easyui-combobox" required="true"></select>
					<label>테이블명</label>
					<select id="selectTableName" name="selectTableName" data-options="panelHeight:'auto',editable:true,panelHeight:500" class="w240 easyui-combobox" required="true"></select>
