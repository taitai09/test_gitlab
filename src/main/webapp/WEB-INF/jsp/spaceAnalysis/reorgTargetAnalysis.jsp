...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/spaceAnalysis/reorgTargetAnalysis.js?ver=<%=today%>"></script>
</head>
...
<div id="container">	
	...
	<div id="contents">
		<div class="easyui-panel searchArea" data-options="border:false" style="width:100%">
			...
			<div class="well">
				<form:form method="post" id="submit_form" name="submit_form" class="form-inline">
					...
					<span class="searchBtn" style="float:none">
		...
		<div class="easyui-layout" data-options="border:false" style="width:100%;min-height:650px">
			<div id="tableChart" data-options="title:'▶ TOP DML Table',region:'west',split:false,collapsible:false,border:true" style="width:50%;padding-top:5px;">
			</div>
			<div id="tableHistoryChart" data-options="title:'▶ TOP DML Table History',region:'center',split:false,collapsible:false,border:true" style="padding-top:5px;">
			</div>
			<div data-options="title:'▶ TOP Reorg Table 50',region:'south',split:false,collapsible:false,border:true" style="height:330px;padding-top:1px;">
