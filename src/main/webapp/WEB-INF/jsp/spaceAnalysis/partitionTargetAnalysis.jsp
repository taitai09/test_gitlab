...
<head>
    ...
    <script type="text/javascript" src="/resources/js/ui/spaceAnalysis/partitionTargetAnalysis.js?ver=<%=today%>"></script>
</head>
...
<div id="container">	
	...
	<div id="contents">
		...
		<div class="easyui-layout" data-options="border:false" style="width:100%;min-height:650px">
			<div id="tableChart" data-options="title:'▶ TOP Size Table',region:'west',split:false,collapsible:false,border:true" style="width:50%;padding:5px 5px 0px 0px;">
			</div>
			<div id="tableHistoryChart" data-options="title:'▶ TOP Size Table History',region:'center',split:false,collapsible:false,border:true" style="padding:5px 0px 0px 5px;">
			</div>
			<div data-options="title:'▶ TOP Size Table 100',region:'south',split:false,collapsible:false,border:true" style="height:330px;padding-top:1px;">
