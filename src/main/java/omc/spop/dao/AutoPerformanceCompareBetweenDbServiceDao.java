...
public interface AutoPerformanceCompareBetweenDbServiceDao {
//	AutoPerformanceCompareBetweenDbServiceMapper
	...
	public List<SQLAutoPerformanceCompare> tableCHGPerfChkTargetAll(
			SQLAutoPerformanceCompare sqlAutoPerformanceCompare );
	...
	public int insertSQLAutoPerfChkTarget(
			SQLAutomaticPerformanceCheck sqlAutomaticPerformanceCheck );
